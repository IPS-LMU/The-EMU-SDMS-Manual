...
```{r rexample:emuRfuncs-help, rexample=TRUE, eval=FALSE}
help(package="emuR")
```
...
```{r rexample:emuR-funcsTxtCol, results='hide', message=FALSE, rexample=TRUE}
...
```{r rexample:emuR-funcsExport, results='hide', message=FALSE, rexample=TRUE}
