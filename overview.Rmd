...
```{r rexample:overview-install, rexample=TRUE, eval=FALSE}
...
```{r overview-archOver, fig.align="center", fig.cap="Schematic architecture of the EMU-SDMS", echo=FALSE, out.width = "75%"}
knitr::include_graphics("pics/overview.png")
```
...
```{r overview-hybridAnnot, fig.align = "center", fig.cap = "Example of a hybrid annotation combining time-based (*Phonetic* level) and hierarchical (*Phoneme*, *Syllable*, *Text* levels including the inter-level links) annotations.", echo=FALSE, out.width = "75%"}
