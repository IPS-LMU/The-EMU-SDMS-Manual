...
```{r rexample:app-chap-useCasesLoadData, rexample=TRUE, results='hide', message=FALSE}
# load the package 
library(emuR)
...
```{r rexample:usecases-uc1query, rexample=TRUE}
# query segments
...
```{r rexample:usecases-uc1eval, rexample=TRUE}
# calculate durations
d = dur(sl)
...
```{r rexample:usecases_uc2query, rexample=TRUE}
# query emuDB
...
```{r rexample:usecases-uc2gettd, rexample=TRUE, message=FALSE, results='hide'}
...
```{r rexample:usecases-uc2class, rexample=TRUE}
...
```{r rexample:usecases-uc2plot, rexample=TRUE, eval=FALSE}
# load package
library(ggplot2)
...
```{r rexample:usecases_uc3query, rexample=TRUE}
# query segments
...
```{r rexample:usecases-uc3requery1, rexample=TRUE}
# perform requery
...
```{r rexample:usecases-uc3requery2, rexample=TRUE}
# perform requery
...
```{r rexample:usecases-uc3requerySeqLeft, rexample=TRUE}
...
```{r rexample:usecases-uc3requerySeqRight, rexample=TRUE, error=TRUE}
...
```{r rexample:usecases-uc3requerySeqRight2, rexample=TRUE}
...
```{r rexample:usecases-uc4query, rexample=TRUE}
...
```{r rexample:usecases-uc4gettd, rexample=TRUE, results='hide', message=FALSE}
...
```{r rexample:usecases-uc4index, rexample=TRUE}
...
```{r rexample:usecases-uc4fapply, rexample=TRUE}
...
```{r rexample:usecases-uc4showMoments, rexample=TRUE}
...
```{r rexample:usecases-uc4dplot1, rexample=TRUE, eval=FALSE, fig.align="center"}
...
```{r rexample:usecases-uc4dplot2, rexample=TRUE, eval=FALSE}
dplot(dftTdRelFreqMom[,1],
      sibil$labels,
      normalise = TRUE,
      average = TRUE,
...
```{r rexample:usecases-uc4dcut, rexample=TRUE}
...
```{r rexample:usecases-uc4trapply, rexample=TRUE}
...
```{r rexample:usecases-uc4boxplot, rexample=TRUE, eval=FALSE}
