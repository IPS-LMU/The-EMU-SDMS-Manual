...
```{r rexample:wrassp-readSSFF, rexample=TRUE}
...
```{r wrassp-ssffDataBlock, fig.cap="Schematic representation of the data block of the `msajc003.fms` file of R Example ref{rexample:wrassp-readSSFF}.", fig.align="center", echo=FALSE, out.width = "100%"}
