...
library(dplyr)
library(knitr)
dt = data.frame(Protocol_Command = c("`GETPROTOCOL`",
                                     "`GETDOUSERMANAGEMENT`",
                                     "`GETGLOBALDBCONFIG`",
                                     "`GETBUNDLELIST`",
                                     "`GETBUNDLE`",
                                     "`SAVEBUNDLE`"),
                Comments = c("Check if the server implements the correct protocol",
                             "See if the server handles user management (if yes, then this prompts a login dialog $\rightarrow$ `LOGONUSER`",
...
- TextGrid example: https://ips-lmu.github.io/EMU-webApp/?audioGetUrl=https://raw.githubusercontent.com/IPS-LMU/EMU-webApp/master/src/testData/oldFormat/msajc003/msajc003.wav&labelGetUrl=https://raw.githubusercontent.com/IPS-LMU/EMU-webApp/master/src/testData/oldFormat/msajc003/msajc003.TextGrid&labelType=TEXTGRID
- annotJSON example: https://ips-lmu.github.io/EMU-webApp/?audioGetUrl=https://raw.githubusercontent.com/IPS-LMU/EMU-webApp/master/src/testData/newFormat/ae/0000_ses/msajc003_bndl/msajc003.wav&labelGetUrl=https://raw.githubusercontent.com/IPS-LMU/EMU-webApp/master/src/testData/newFormat/ae/0000_ses/msajc003_bndl/msajc003_annot.json&labelType=annotJSON
