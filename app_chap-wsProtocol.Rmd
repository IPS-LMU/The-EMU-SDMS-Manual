...
```{r app-chapWsProtocolGraph, fig.cap="Schematic of the `EMU-webApp-websocket-protocol`.",fig.align="center", echo=FALSE, out.width = "75%"}
knitr::include_graphics("pics/protocol.png")
```
