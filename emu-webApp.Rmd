...
knitr::include_graphics("pics/EMU-webAppEmu_emu-webApp.png")
```
...
```{r rexample:webApp-serve, rexample=TRUE, eval=FALSE}
# serve ae emuDB to EMU-webApp
serve(ae)
```

```{r emu-web-emuWebAppLayout, fig.cap="Screenshot of `EMU-webApp` displaying the *ae* demo database with overlaid areas of the main screen of the web application (see text).", fig.align="center", echo=FALSE, out.width = "100%"}
knitr::include_graphics("pics/emu-webAppLayout.png")
```
...
```{r webApp-preSelBoundary, fig.cap="Screenshot of segment level as displayed by the `EMU-webApp` with superimposed mouse cursor displaying the automatic boundary preselection of closest boundary (boundary marked blue).", fig.align="center", echo=FALSE, out.width = "40%"}
knitr::include_graphics("pics/preSelBoundary.png")
```
...
```{r webApp-selectLevel, fig.cap="Screenshot of two levels as displayed by the `EMU-webApp`, where the lower level is preselected (i.e., marked in a darker shade of gray).", fig.align="center", echo=FALSE, out.width = "40%"}
knitr::include_graphics("pics/selectLevel.png")
```
...
```{r webApp-preSelSeg, fig.cap="Screenshot of level as displayed by the `EMU-webApp`, where the /@/ segment is currently preselected as it is marked yellow.", fig.align="center", echo=FALSE, out.width = "40%"}
knitr::include_graphics("pics/preSelSeg.png")
```
...
```{r webApp-parTimeLevel, fig.cap="Screenshot of segment level with three attribute definitions. The radio buttons that switch between the parallel labels are highlighted by a red square.", fig.align="center", echo=FALSE, out.width = "75%"}
knitr::include_graphics("pics/emu-webAppParTimeLevel.png")
```
...
```{r webApp-hierModal, fig.cap="Screenshot of the hierarchy modal window level displaying a path through the hierarchy of the *ae* `emuDB` in its horizontal form.", fig.align="center", echo=FALSE, out.width = "75%"}
knitr::include_graphics("pics/emu-webAppHierModal.png")
```
...
```{r webApp-hierModalTop, fig.cap="Screenshot of top of hierarchy modal window of the `EMU-webApp` in which the area marked 1 shows the drop-down menus for selecting the parallel label for each level and area 2 marks the hierarchy path drop-down menu.", fig.align="center", echo=FALSE, out.width = "85%"}
knitr::include_graphics("pics/emu-webAppHierModalTop.png")
```
...
```{r webApp-hierContextMenu, fig.cap="Screenshot of the hierarchy modal window of the `EMU-webApp` displaying an annotation item's context menu.", fig.align="center", echo=FALSE, out.width = "65%"}
knitr::include_graphics("pics/emu-webAppHierContextMenu.png")
```
...
```{r webApp-perspMenu, fig.cap="Screenshot of the hierarchy modal window of the `EMU-webApp` displaying an annotation item's context menu.", fig.align="center", echo=FALSE, out.width = "25%"}
knitr::include_graphics("pics/emu-webAppPerspMenu.png")
```
...
```{r rexample:webApp-loadDemoData, rexample=TRUE, results='hide', message=FALSE}
# load package
library(emuR)
...
```{r rexample:webApp-listPersp, rexample=TRUE}
...
```{r rexample:webApp-addRemovePersp, rexample=TRUE}
...
```{r rexample:webApp-oders, rexample=TRUE}
...
```{r rexample:webApp-badLevelOrders, rexample=TRUE, error=TRUE}
...
```{r rexample:webApp-addFormantsToSignalCanvases, rexample=TRUE}
...
```{r webApp-postOderChange, fig.cap="Screenshot of signal and level canvases displays of the `EMU-webApp` after the changes made in R Examples @ref(rexample:webApp-oders) and @ref(rexample:webApp-addFormantsToSignalCanvases).", fig.align="center", echo=FALSE, out.width = "100%"}
knitr::include_graphics("pics/emu-webAppPostOderChange.png")
```
...
```{r webApp-overlay1, fig.cap="Screenshot of signal canvases display of the `EMU-webApp` after the changes made in R Examples @ref(rexample:webApp-oders) and @ref(rexample:webApp-addFormantsToSignalCanvases).", fig.align="center", echo=FALSE, out.width = "100%"}
knitr::include_graphics("pics/emu-webAppOverlay.png")
```
...
```{r webApp-overlay2, fig.cap="Screenshot of signal canvases area of the `EMU-webApp` displaying formant contours that are overlaid on the spectrogram and frequency-aligned.", fig.align="center", echo=FALSE, out.width = "100%"}
knitr::include_graphics("pics/emu-webAppOverlayFreqAlg.png")
```
...
```{r webApp-2dCanvas, fig.cap="Screenshot of 2D canvas of the `EMU-webApp` displaying two-dimensional EMA data.", fig.align="center", echo=FALSE, out.width = "35%"}
knitr::include_graphics("pics/emu-webApp2dCanvas.png")
```

<!-- [caption={Configuration of the 2D canvas to display \ac{ema} data.}, label={lst:webApp_2dCanvas}, language=json, firstnumber=1] -->
```{json lst:webApp_2dCanvas}
...
"twoDimCanvases": {
	"order": ["DOTS"],
...
```{r webApp-2dEPG, fig.cap="Screenshot of 2D canvas of the `EMU-webApp` displaying EPG palate traces.", fig.align="center", echo=FALSE, out.width = "35%"}
knitr::include_graphics("pics/emu-webApp2dEPG.png")
```

<!-- [caption={Configuration of the 2D canvas to display \ac{epg} data}, label={lst:webApp_2dEPG}, language=json, firstnumber=1] -->
```{json lst:webApp_2dEPG}
"twoDimCanvases": {
	"order": ["EPG"]
}
```
