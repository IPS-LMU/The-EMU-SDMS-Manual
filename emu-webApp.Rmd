...
```{r webApp-postOderChange, fig.cap="Screenshot of signal and level canvases displays of the `EMU-webApp` after the changes made in the above R code snippets.", fig.align="center", echo=FALSE, out.width = "100%"}
...
```{r webApp-overlay1, fig.cap="Screenshot of signal canvases display of the `EMU-webApp` after the changes made in the R code snippets above.", fig.align="center", echo=FALSE, out.width = "100%"}
