...
knitr::include_graphics("pics/EMU-webAppEmu_wrassp.png")
```
...
```{r webApp-preSelBoundary, fig.cap="Screenshot of segment level as displayed by the `EMU-webApp` with superimposed mouse cursor displaying the automatic boundary preselection of closest boundary (boundary marked blue).", fig.align="center", echo=FALSE, out.width = "75%"}
...
```{r webApp-selectLevel, fig.cap="Screenshot of two levels as displayed by the `EMU-webApp`, where the lower level is preselected (i.e., marked in a darker shade of gray).", fig.align="center", echo=FALSE, out.width = "75%"}
...
```{r webApp-preSelSeg, fig.cap="Screenshot of level as displayed by the `EMU-webApp`, where the /@/ segment is currently preselected as it is marked yellow.", fig.align="center", echo=FALSE, out.width = "75%"}
...
```{r webApp-hierModalTop, fig.cap="Screenshot of top of hierarchy modal window of the `EMU-webApp` in which the area marked 1 shows the drop-down menus for selecting the parallel label for each level and area 2 marks the hierarchy path drop-down menu.", fig.align="center", echo=FALSE, out.width = "75%"}
...
```{r webApp-hierContextMenu, fig.cap="Screenshot of the hierarchy modal window of the `EMU-webApp` displaying an annotation item's context menu.", fig.align="center", echo=FALSE, out.width = "75%"}
...
```{r webApp-perspMenu, fig.cap="Screenshot of the hierarchy modal window of the `EMU-webApp` displaying an annotation item's context menu.", fig.align="center", echo=FALSE, out.width = "75%"}
...
```{r webApp-postOderChange, fig.cap="Screenshot of signal and level canvases displays of the `EMU-webApp` after the changes made in R Examples @ref(rexample:webApp-oders) and @ref(rexample:webApp-addFormantsToSignalCanvases).", fig.align="center", echo=FALSE, out.width = "75%"}
...
```{json lst:webApp-overlay, fig.cap="sdfjskld"}
...
"assign": [{
...
```{r webApp-overlay1, fig.cap="Screenshot of signal canvases display of the `EMU-webApp` after the changes made in R Examples @ref(rexample:webApp-oders) and @ref(rexample:webApp-addFormantsToSignalCanvases).", fig.align="center", echo=FALSE, out.width = "75%"}
...
```{r webApp-overlay2, fig.cap="Screenshot of signal canvases area of the `EMU-webApp` displaying formant contours that are overlaid on the spectrogram and frequency-aligned.", fig.align="center", echo=FALSE, out.width = "75%"}
...
```{r webApp-2dCanvas, fig.cap="Screenshot of 2D canvas of the `EMU-webApp` displaying two-dimensional EMA data.", fig.align="center", echo=FALSE, out.width = "75%"}
...
```{r webApp-2dEPG, fig.cap="Screenshot of 2D canvas of the `EMU-webApp` displaying EPG palate traces.", fig.align="center", echo=FALSE, out.width = "75%"}
