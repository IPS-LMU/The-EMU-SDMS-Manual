...
library(dplyr)
library(knitr)
dt = data.frame(uuid = c("0fc618dc-8980-414d-8c7a-144a649ce199"),
                name = c("ae"))
dt %>%
  kable("html")
```
...
```{r echo=FALSE, message=FALSE}
dt = data.frame(db_uuid = c("0fc618dc-8980-414d-8c7a-144a649ce199"),
                name = c("0000"))
dt %>%
  kable("html")
```
...
dt = data.frame(db_uuid = c("0fc618dc-8980-414d-8c7a-144a649ce199", "..."),
                session = c("0000", "..."),
                name = c("msajc003", "..."),
                annotates = c("msajc003.wav", "..."),
                sample_rate = c(20000, "..."),
                md5_annot_json = c("785c7cdb6d4bd5e8b5cd7c56a5946ddf", "..."))
dt %>%
  kable("html")
```
...
```{r query-queryParserExample1, fig.cap="Example of how the query expression parser parses and evaluates an EQL expression and merges the result according to the respective EQL operators.", fig.align="center", echo=FALSE, out.width = "100%"}
knitr::include_graphics("pics/queryParserExample1.png")
```
...
```{r query-implQueryEnginePC-p1, fig.cap="Pseudo Code for Query Engine Algorithm - Part 1", fig.align="center", echo=FALSE, out.width = "90%"}
knitr::include_graphics("pics/algorithm1.png")
```
...
```{r query-implQueryEnginePC-p2, fig.cap="Pseudo Code for Query Engine Algorithm - Part 2", fig.align="center", echo=FALSE, out.width = "90%"}
knitr::include_graphics("pics/algorithm2.png")
```
...
```{r query-redundant, fig.cap="Schematic of hierarchy graph *ae*; \textbf{A}: legacy redundant strategy vs. \textbf{A}: cleaner non-redundant strategy.", fig.align="center", echo=FALSE, out.width = "75%"}
knitr::include_graphics("pics/aeGraph_redundant.png")
```
