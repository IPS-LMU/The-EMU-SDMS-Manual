...
```{r rexample:overview_install, eval=FALSE}
...
<!-- ```{r, fig:overview_archOver, fig.cap="Schematic architecture of the EMU-SDMS", echo=FALSE} -->
<!-- knitr::include_graphics("pics/overview.pdf") -->
<!-- ``` -->

![Schematic architecture of the EMU-SDMS.(\#fig:overview_archOver)](pics/overview.png)
...
```{r, overview_hybridAnnot, fig.cap = "Example of a hybrid annotation combining time-based (*Phonetic* level) and hierarchical (*Phoneme*, *Syllable*, *Text* levels including the inter-level links) annotations.", echo=FALSE, fig.width=4.5, fig.height=3}
library(ggplot2)
