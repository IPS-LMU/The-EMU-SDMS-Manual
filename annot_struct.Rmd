...
```{r annotStruct, fig.cap="**A:** a schematic representation of the hierarchical structure of an `emuDB` that corresponds to the annotation depicted in @ref(fig:annot-structhybridAnnot)C; **B:** example of a more complex, intersecting hierarchical structure.", fig.align="center", echo=FALSE, out.width = "75%"}
