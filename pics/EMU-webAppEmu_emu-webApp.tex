...
;
% eye
\draw (200.00mm, -870.00mm) circle (8mm);
\draw [fill=black](200.00mm, -870.00mm) circle (3mm);

% bubbles
\draw (280.00mm,-900.00mm) circle (10mm);
\draw (320.00mm,-900.00mm) circle (12mm);

\node[cloud, aspect=2, draw=black, text width=4cm] at (510.00mm,-900.00mm){It all looks the same to me!};

% icons
\node (ch) at (320.00mm,-737.00mm) [] {\pgftext{\includegraphics[scale=0.015]{pics/2000px-Google_Chrome_icon.png}}};
\node (slash1) at (360.00mm,-737.00mm) [] {/};
\node (ff) at (400.00mm,-737.00mm) [] {\pgftext{\includegraphics[scale=0.06]{pics/firefox-512.png}}};
\node (slash2) at (440.00mm,-737.00mm) [] {/};
\node (safari) at (480.00mm,-737.00mm) [] {\pgftext{\includegraphics[scale=0.050]{pics/safari.png}}};
\node (slashdots) at (530.00mm,-737.00mm) [] {/ \dots};
