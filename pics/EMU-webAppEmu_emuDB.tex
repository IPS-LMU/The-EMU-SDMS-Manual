...
\begin{scope}[xscale=-1, xshift=-450mm]
%  draw EMU logo head
...
\node[cloud, aspect=2, draw=black, text width=2cm] at (450.00mm,-747.00mm){Our baby!};

\end{scope}

\begin{scope}[yshift=-900mm, scale=2.5]
\draw[looseness=0.9,ball color=blue!60!green,opacity=.7, draw=none] (-2,0) arc (180:360:2) to[out=90,in=0] (0,3) to[out=180,in=90] (-2,0) -- cycle;
\end{scope}


\node [minimum width=1.8cm, minimum height=1.8cm](emuDB) at (0, -900mm) {\pgftext{\includegraphics[scale=0.2]{pics/databaseSymbol}}};
