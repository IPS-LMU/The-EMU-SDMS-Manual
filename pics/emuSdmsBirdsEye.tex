...
\begin{tikzpicture}
  ...
  % pics
  \node [minimum width=6cm, minimum height=6cm](emusdms) at (0, 0) {\pgftext{\includegraphics[scale=0.2]{EMU-webAppIcon-roundCorners}}};

  \node [minimum width=1.8cm, minimum height=1.8cm](emuDB) at (0, 0) {\pgftext{\includegraphics[scale=0.2]{databaseSymbol}}};
