...
```
## [2a35313] 2020-12-16: initial commit
```
...
```
## [1] "INFO: No bundleList dir found in emuDB (path: C:\\Users\\rapha\\AppData\\Local\\Temp\\Rtmpy4MX7q\\emuR_demoData\\ae_emuDB/bundleLists)! Creating directory..."
```
