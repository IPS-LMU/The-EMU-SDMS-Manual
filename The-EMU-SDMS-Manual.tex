...
\FunctionTok{max}\NormalTok{(td\_vowels}\SpecialCharTok{$}\NormalTok{sl\_rowIdx)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{td\_vowels\_mid\_sec }\OtherTok{=}\NormalTok{ td\_vowels\_norm }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{filter}\NormalTok{(times\_norm }\SpecialCharTok{\textgreater{}=} \FloatTok{0.2}\NormalTok{, times\_norm }\SpecialCharTok{\textless{}=} \FloatTok{0.8}\NormalTok{)}

\CommentTok{\# replace labels with those of sl\_word\_type}
\NormalTok{td\_vowels\_mid\_sec}\SpecialCharTok{$}\NormalTok{labels }\OtherTok{=}\NormalTok{ sl\_word\_type}\SpecialCharTok{$}\NormalTok{labels[td\_vowels\_mid\_sec}\SpecialCharTok{$}\NormalTok{sl\_rowIdx]}

\FunctionTok{ggplot}\NormalTok{(td\_vowels\_mid\_sec) }\SpecialCharTok{+}
  \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ times\_norm, }\AttributeTok{y =}\NormalTok{ T1, }\AttributeTok{col =}\NormalTok{ labels, }\AttributeTok{group =}\NormalTok{ labels) }\SpecialCharTok{+}
  \FunctionTok{geom\_smooth}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Duration (normalized)"}\NormalTok{, }\AttributeTok{y =} \StringTok{"F1 (Hz)"}\NormalTok{) }
\end{Highlighting}
...
\NormalTok{distrF }\OtherTok{=} \FunctionTok{density}\NormalTok{(td\_vowels\_mid\_sec\_mean[td\_vowels\_mid\_sec\_mean}\SpecialCharTok{$}\NormalTok{labels }\SpecialCharTok{==} \StringTok{"F"}\NormalTok{,]}\SpecialCharTok{$}\NormalTok{meanF1)}
...
\FunctionTok{shapiro.test}\NormalTok{(td\_vowels\_mid\_sec\_mean[td\_vowels\_mid\_sec\_mean}\SpecialCharTok{$}\NormalTok{labels }\SpecialCharTok{==} \StringTok{"F"}\NormalTok{,]}\SpecialCharTok{$}\NormalTok{meanF1)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# p{-}value \textgreater{} 0.05 implying that the distribution}
\CommentTok{\# of the data ARE NOT significantly different from}
\CommentTok{\# normal distribution {-}\textgreater{} we CAN assume normality}

\CommentTok{\# calculate density for vowels in content words}
\NormalTok{distrC }\OtherTok{=} \FunctionTok{density}\NormalTok{(td\_vowels\_mid\_sec\_mean[td\_vowels\_mid\_sec\_mean}\SpecialCharTok{$}\NormalTok{labels }\SpecialCharTok{==} \StringTok{"C"}\NormalTok{,]}\SpecialCharTok{$}\NormalTok{meanF1)}
...
\CommentTok{\# words are normally distributed:}
\FunctionTok{shapiro.test}\NormalTok{(td\_vowels\_mid\_sec\_mean[td\_vowels\_mid\_sec\_mean}\SpecialCharTok{$}\NormalTok{labels }\SpecialCharTok{==} \StringTok{"C"}\NormalTok{,]}\SpecialCharTok{$}\NormalTok{meanF1)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{dim}\NormalTok{(au}\SpecialCharTok{$}\NormalTok{audio)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{head}\NormalTok{(au}\SpecialCharTok{$}\NormalTok{audio, }\AttributeTok{n =} \DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{samplesIdx }\OtherTok{=} \FunctionTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FunctionTok{numRecs.AsspDataObj}\NormalTok{(au) }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{, }\DecValTok{10}\NormalTok{)}
\NormalTok{samplesTime }\OtherTok{=}\NormalTok{ samplesIdx }\SpecialCharTok{/} \FunctionTok{rate.AsspDataObj}\NormalTok{(au)}

\CommentTok{\# extract every 10th sample using window() function}
\NormalTok{samples }\OtherTok{=} \FunctionTok{window}\NormalTok{(au}\SpecialCharTok{$}\NormalTok{audio, }\AttributeTok{deltat=}\DecValTok{10}\NormalTok{)}

\CommentTok{\# plot samples stored in audio attribute}
\CommentTok{\# (only plot every 10th sample to accelerate plotting)}
\FunctionTok{plot}\NormalTok{(samplesTime,}
\NormalTok{     samples,}
     \AttributeTok{type =} \StringTok{"l"}\NormalTok{,}
     \AttributeTok{xlab =} \StringTok{"time (s)"}\NormalTok{,}
     \AttributeTok{ylab =} \StringTok{"Audio samples (INT16)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{au}\SpecialCharTok{$}\NormalTok{audio }\OtherTok{=}\NormalTok{ au}\SpecialCharTok{$}\NormalTok{audio }\SpecialCharTok{*} \FloatTok{0.5}
\CommentTok{\# write to file in directory}
\CommentTok{\# provided by tempdir()}
\FunctionTok{write.AsspDataObj}\NormalTok{(au, }\FunctionTok{file.path}\NormalTok{(}\FunctionTok{tempdir}\NormalTok{(), }\StringTok{\textquotesingle{}newau.wav\textquotesingle{}}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{wrasspOutputInfos}\SpecialCharTok{$}\NormalTok{forest}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{dim}\NormalTok{(fmBwVals}\SpecialCharTok{$}\NormalTok{fm)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{all}\NormalTok{(}\FunctionTok{dim}\NormalTok{(fmBwVals}\SpecialCharTok{$}\NormalTok{fm) }\SpecialCharTok{==} \FunctionTok{dim}\NormalTok{(fmBwVals}\SpecialCharTok{$}\NormalTok{bw))}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{matplot}\NormalTok{(}\FunctionTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FunctionTok{numRecs.AsspDataObj}\NormalTok{(fmBwVals) }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{)}
        \SpecialCharTok{/} \FunctionTok{rate.AsspDataObj}\NormalTok{(fmBwVals)}
        \SpecialCharTok{+} \FunctionTok{attr}\NormalTok{(fmBwVals, }\StringTok{"startTime"}\NormalTok{),}
\NormalTok{        fmBwVals}\SpecialCharTok{$}\NormalTok{fm,}
        \AttributeTok{type =} \StringTok{"l"}\NormalTok{,}
        \AttributeTok{xlab =} \StringTok{"time (s)"}\NormalTok{,}
        \AttributeTok{ylab =} \StringTok{"Formant frequency (Hz)"}\NormalTok{)}
\CommentTok{\# add legend}
\NormalTok{startFormant }\OtherTok{=} \DecValTok{1}
\NormalTok{endFormant }\OtherTok{=} \DecValTok{4}
\FunctionTok{legend}\NormalTok{(}\StringTok{"topright"}\NormalTok{,}
       \AttributeTok{legend =} \FunctionTok{paste0}\NormalTok{(}\StringTok{"F"}\NormalTok{, startFormant}\SpecialCharTok{:}\NormalTok{endFormant),}
       \AttributeTok{col =}\NormalTok{ startFormant}\SpecialCharTok{:}\NormalTok{endFormant,}
       \AttributeTok{lty =}\NormalTok{ startFormant}\SpecialCharTok{:}\NormalTok{endFormant,}
...
\NormalTok{path2f0file }\OtherTok{=} \FunctionTok{file.path}\NormalTok{(path2bndl,}
                    \FunctionTok{paste0}\NormalTok{(}\StringTok{"msajc003."}\NormalTok{,}
\NormalTok{                           wrasspOutputInfos}\SpecialCharTok{$}\NormalTok{ksvF0}\SpecialCharTok{$}\NormalTok{ext))}

\CommentTok{\# read file from disk}
\NormalTok{f0vals }\OtherTok{=} \FunctionTok{read.AsspDataObj}\NormalTok{(path2f0file)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{plot}\NormalTok{(}\FunctionTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{,}\FunctionTok{numRecs.AsspDataObj}\NormalTok{(f0vals) }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{)}
     \SpecialCharTok{/} \FunctionTok{rate.AsspDataObj}\NormalTok{(f0vals) }\SpecialCharTok{+}
       \FunctionTok{attr}\NormalTok{(f0vals, }\StringTok{"startTime"}\NormalTok{),}
\NormalTok{     f0vals}\SpecialCharTok{$}\NormalTok{F0,}
     \AttributeTok{type =} \StringTok{"l"}\NormalTok{,}
     \AttributeTok{xlab =} \StringTok{"time (s)"}\NormalTok{,}
     \AttributeTok{ylab =} \StringTok{"F0 frequency (Hz)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{paths2wavFiles }\OtherTok{=} \FunctionTok{list\_files}\NormalTok{(ae, }\AttributeTok{fileExtension =} \StringTok{"wav"}\NormalTok{)}\SpecialCharTok{$}\NormalTok{absolute\_file\_path}

\CommentTok{\# calculate the RMS energy values for all .wav files}
\FunctionTok{rmsana}\NormalTok{(paths2wavFiles)}

\CommentTok{\# list new .rms files using}
\CommentTok{\# wrasspOutputInfos{-}\textgreater{}rmsana{-}\textgreater{}ext}
\NormalTok{rmsFPs }\OtherTok{=} \FunctionTok{list.files}\NormalTok{(path2ae,}
                    \AttributeTok{pattern =} \FunctionTok{paste0}\NormalTok{(}\StringTok{".*"}\NormalTok{,}
\NormalTok{                                     wrasspOutputInfos}\SpecialCharTok{$}\NormalTok{rmsana}\SpecialCharTok{$}\NormalTok{ext),}
                    \AttributeTok{recursive =} \ConstantTok{TRUE}\NormalTok{,}
                    \AttributeTok{full.names =} \ConstantTok{TRUE}\NormalTok{)}

\CommentTok{\# read first RMS file}
\NormalTok{rmsvals }\OtherTok{=} \FunctionTok{read.AsspDataObj}\NormalTok{(rmsFPs[}\DecValTok{1}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{plot}\NormalTok{(}\FunctionTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FunctionTok{numRecs.AsspDataObj}\NormalTok{(rmsvals) }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{)}
     \SpecialCharTok{/} \FunctionTok{rate.AsspDataObj}\NormalTok{(rmsvals)}
     \SpecialCharTok{+} \FunctionTok{attr}\NormalTok{(rmsvals, }\StringTok{"startTime"}\NormalTok{),}
\NormalTok{     rmsvals}\SpecialCharTok{$}\NormalTok{rms,}
     \AttributeTok{type =} \StringTok{"l"}\NormalTok{,}
     \AttributeTok{xlab =} \StringTok{"time (s)"}\NormalTok{,}
     \AttributeTok{ylab =} \StringTok{"RMS energy (dB)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ext }\OtherTok{=}\NormalTok{ wrasspOutputInfos}\SpecialCharTok{$}\NormalTok{rmsana}\SpecialCharTok{$}\NormalTok{ext}
\NormalTok{colName }\OtherTok{=}\NormalTok{ wrasspOutputInfos}\SpecialCharTok{$}\NormalTok{rmsana}\SpecialCharTok{$}\NormalTok{tracks[}\DecValTok{1}\NormalTok{]}
\FunctionTok{add\_ssffTrackDefinition}\NormalTok{(ae,}
                        \AttributeTok{name =} \StringTok{"rms"}\NormalTok{,}
                        \AttributeTok{fileExtension =}\NormalTok{ ext,}
                        \AttributeTok{columnName =}\NormalTok{ colName)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{zcranaParams}\SpecialCharTok{$}\NormalTok{windowSize }\OtherTok{=} \DecValTok{50}

\CommentTok{\# to have a segment list to work with}
\CommentTok{\# query all Phonetic \textquotesingle{}n\textquotesingle{} segments}
...
\CommentTok{\# (verbose = F is only set to avoid additional output in manual)}
\NormalTok{td }\OtherTok{=} \FunctionTok{get\_trackdata}\NormalTok{(ae, sl,}
                   \AttributeTok{onTheFlyFunctionName =} \StringTok{"zcrana"}\NormalTok{,}
                   \AttributeTok{onTheFlyParams =}\NormalTok{ zcranaParams,}
                   \AttributeTok{verbose =} \ConstantTok{FALSE}\NormalTok{)}
...
\CommentTok{\# (verbose = F is only set to avoid additional output in manual)}
\FunctionTok{add\_ssffTrackDefinition}\NormalTok{(ae,}
                        \AttributeTok{name =} \StringTok{"zcr"}\NormalTok{,}
                        \AttributeTok{onTheFlyFunctionName =} \StringTok{"zcrana"}\NormalTok{,}
                        \AttributeTok{onTheFlyParams =}\NormalTok{ zcranaParams,}
                        \AttributeTok{verbose =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
...
\hypertarget{sec:wrassp-genSSFF}{%
\section{Storing data in the SSFF file format}\label{sec:wrassp-genSSFF}}
...
\NormalTok{d }\OtherTok{=}\NormalTok{ sl}\SpecialCharTok{$}\NormalTok{end }\SpecialCharTok{{-}}\NormalTok{ sl}\SpecialCharTok{$}\NormalTok{start}
...
\FunctionTok{ggplot}\NormalTok{(td, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{T2, }\AttributeTok{y=}\NormalTok{T1, }\AttributeTok{label=}\NormalTok{td}\SpecialCharTok{$}\NormalTok{labels)) }\SpecialCharTok{+}
  \FunctionTok{geom\_text}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{colour=}\FunctionTok{factor}\NormalTok{(labels))) }\SpecialCharTok{+}
  \FunctionTok{scale\_y\_reverse}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{scale\_x\_reverse}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"F2(Hz)"}\NormalTok{, }\AttributeTok{y =} \StringTok{"F1(Hz)"}\NormalTok{) }\SpecialCharTok{+}
...
\NormalTok{dftTdRelFreqMom[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{$}\NormalTok{data[}\DecValTok{1}\NormalTok{,]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{dplot}\NormalTok{(dftTdRelFreqMom[, }\DecValTok{1}\NormalTok{],}
\NormalTok{      sibil}\SpecialCharTok{$}\NormalTok{labels,}
      \AttributeTok{normalise =} \ConstantTok{TRUE}\NormalTok{,}
      \AttributeTok{xlab =} \StringTok{"Normalized Time [\%]"}\NormalTok{,}
      \AttributeTok{ylab =} \StringTok{"1st spectral moment [Hz]"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{      sibil}\SpecialCharTok{$}\NormalTok{labels,}
      \AttributeTok{normalise =} \ConstantTok{TRUE}\NormalTok{,}
      \AttributeTok{average =} \ConstantTok{TRUE}\NormalTok{,}
      \AttributeTok{xlab =} \StringTok{"Normalized Time [\%]"}\NormalTok{,}
      \AttributeTok{ylab =} \StringTok{"1st spectral moment [Hz]"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{boxplot}\NormalTok{(meanFirstMoments }\SpecialCharTok{\textasciitilde{}}\NormalTok{ sibil}\SpecialCharTok{$}\NormalTok{labels, }
        \AttributeTok{xlab =} \StringTok{"Sibilant class labels"}\NormalTok{,}
        \AttributeTok{ylab =} \StringTok{"First spectral moment values [Hz]"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{path2fmsFile }\OtherTok{=} \FunctionTok{file.path}\NormalTok{(path2bndl, }
                        \FunctionTok{paste0}\NormalTok{(}\StringTok{"msajc003."}\NormalTok{, }
\NormalTok{                               wrasspOutputInfos}\SpecialCharTok{$}\NormalTok{forest}\SpecialCharTok{$}\NormalTok{ext))}

\CommentTok{\# read in first 8 lines of .fms file.}
\CommentTok{\# Note that the header length may vary in other SSFF files.}
\FunctionTok{readLines}\NormalTok{(path2fmsFile, }\AttributeTok{n =} \DecValTok{8}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  ado }\OtherTok{=}\NormalTok{ wrassp}\SpecialCharTok{::}\FunctionTok{addTrack}\NormalTok{(ado, columnNames[}\DecValTok{2}\NormalTok{], bwVals, }\StringTok{"INT16"}\NormalTok{)}
  ...
  \ControlFlowTok{if}\NormalTok{(startTime }\SpecialCharTok{\textgreater{}} \DecValTok{1}\SpecialCharTok{/}\NormalTok{sR) \{}
\NormalTok{    nr\_of\_missing\_samples }\OtherTok{=} \FunctionTok{floor}\NormalTok{(startTime }\SpecialCharTok{/}\NormalTok{ (}\DecValTok{1}\SpecialCharTok{/}\NormalTok{sR))}

\NormalTok{    missing\_fm\_vals }\OtherTok{=} \FunctionTok{matrix}\NormalTok{(}\DecValTok{0}\NormalTok{,}
                             \AttributeTok{nrow =}\NormalTok{ nr\_of\_missing\_samples,}
                             \AttributeTok{ncol =} \FunctionTok{ncol}\NormalTok{(ado}\SpecialCharTok{$}\NormalTok{fm))}

\NormalTok{    missing\_bw\_vals }\OtherTok{=} \FunctionTok{matrix}\NormalTok{(}\DecValTok{0}\NormalTok{,}
                             \AttributeTok{nrow =}\NormalTok{ nr\_of\_missing\_samples,}
                             \AttributeTok{ncol =} \FunctionTok{ncol}\NormalTok{(ado}\SpecialCharTok{$}\NormalTok{bw))}

    \CommentTok{\# prepend values}
\NormalTok{    ado}\SpecialCharTok{$}\NormalTok{fm }\OtherTok{=} \FunctionTok{rbind}\NormalTok{(missing\_fm\_vals, ado}\SpecialCharTok{$}\NormalTok{fm)}
\NormalTok{    ado}\SpecialCharTok{$}\NormalTok{bw }\OtherTok{=} \FunctionTok{rbind}\NormalTok{(missing\_fm\_vals, ado}\SpecialCharTok{$}\NormalTok{bw)}

    \CommentTok{\# fix start time}
    \FunctionTok{attr}\NormalTok{(ado, }\StringTok{"startTime"}\NormalTok{) }\OtherTok{=}\NormalTok{ startTime }\SpecialCharTok{{-}}\NormalTok{ nr\_of\_missing\_samples }\SpecialCharTok{*}\NormalTok{ (}\DecValTok{1}\SpecialCharTok{/}\NormalTok{sR)}
    \FunctionTok{return}\NormalTok{(ado)}
\NormalTok{  \}}
\NormalTok{\}}
...
\CommentTok{\#}
\CommentTok{\# function to run Praat formant script}
\NormalTok{praat\_run\_pitch }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(tmpPraatScript,}
\NormalTok{                            path,}
\NormalTok{                            time\_step,}
\NormalTok{                            pitch\_floor,}
\NormalTok{                            pitch\_ceiling,}
...
\NormalTok{    smooth }\OtherTok{=} \DecValTok{1}
\NormalTok{  \} }\ControlFlowTok{else}\NormalTok{ \{}
\NormalTok{    smooth }\OtherTok{=} \DecValTok{0}
\NormalTok{  \}}
...
\NormalTok{  pitchInfo }\OtherTok{=} \FunctionTok{read.csv}\NormalTok{(tmpPitchInfo, }\AttributeTok{stringsAsFactors =} \ConstantTok{FALSE}\NormalTok{)}

\NormalTok{  nframes }\OtherTok{=}\NormalTok{ pitchInfo}\SpecialCharTok{$}\NormalTok{nframes[}\DecValTok{1}\NormalTok{]}
\NormalTok{  timestep }\OtherTok{=}\NormalTok{ pitchInfo}\SpecialCharTok{$}\NormalTok{timestep[}\DecValTok{1}\NormalTok{]}
\NormalTok{  sR }\OtherTok{=} \DecValTok{1}\SpecialCharTok{/}\NormalTok{timestep}
\NormalTok{  start }\OtherTok{=}\NormalTok{ pitchInfo}\SpecialCharTok{$}\NormalTok{start[}\DecValTok{1}\NormalTok{]}
\NormalTok{  end }\OtherTok{=}\NormalTok{ pitchInfo}\SpecialCharTok{$}\NormalTok{end[}\DecValTok{1}\NormalTok{]}

  \CommentTok{\# create empty df that holds all time steps}
\NormalTok{  df }\OtherTok{=} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{Time =} \FunctionTok{seq}\NormalTok{(start, end, }\AttributeTok{by =}\NormalTok{ timestep), }\AttributeTok{F0 =} \DecValTok{0}\NormalTok{)}
  \CommentTok{\# get vals}
\NormalTok{  df\_tmp }\OtherTok{=} \FunctionTok{read.csv}\NormalTok{(tmpPraatOut, }\AttributeTok{stringsAsFactors =} \ConstantTok{FALSE}\NormalTok{, }\AttributeTok{sep =} \StringTok{"}\SpecialCharTok{\textbackslash{}t}\StringTok{"}\NormalTok{)[,}\DecValTok{2}\SpecialCharTok{:}\DecValTok{3}\NormalTok{]}
  \CommentTok{\# and fill up empty df (ensures every timestep has a value)}
\NormalTok{  df}\SpecialCharTok{$}\NormalTok{F0[df}\SpecialCharTok{$}\NormalTok{Time }\SpecialCharTok{\%in\%}\NormalTok{ df\_tmp}\SpecialCharTok{$}\NormalTok{Time] }\OtherTok{=}\NormalTok{ df\_tmp}\SpecialCharTok{$}\NormalTok{F0}
\NormalTok{  df}

  \CommentTok{\# create AsspDataObj}
\NormalTok{  ado }\OtherTok{=} \FunctionTok{list}\NormalTok{()}

  \FunctionTok{attr}\NormalTok{(ado, }\StringTok{"trackFormats"}\NormalTok{) }\OtherTok{=} \FunctionTok{c}\NormalTok{(}\StringTok{"INT16"}\NormalTok{)}
  \FunctionTok{attr}\NormalTok{(ado, }\StringTok{"sampleRate"}\NormalTok{) }\OtherTok{=}\NormalTok{ sR}

\NormalTok{  tmpObj }\OtherTok{=}\NormalTok{ wrassp}\SpecialCharTok{::}\FunctionTok{read.AsspDataObj}\NormalTok{(path)}
  \FunctionTok{attr}\NormalTok{(ado, }\StringTok{"origFreq"}\NormalTok{) }\OtherTok{=} \FunctionTok{attr}\NormalTok{(tmpObj, }\StringTok{"sampleRate"}\NormalTok{)}

  \FunctionTok{attr}\NormalTok{(ado, }\StringTok{"startTime"}\NormalTok{) }\OtherTok{=}\NormalTok{ start}
  \FunctionTok{attr}\NormalTok{(ado, }\StringTok{"endRecord"}\NormalTok{) }\OtherTok{=} \FunctionTok{as.integer}\NormalTok{(nframes)}

  \FunctionTok{class}\NormalTok{(ado) }\OtherTok{=} \StringTok{"AsspDataObj"}

\NormalTok{  wrassp}\SpecialCharTok{::}\FunctionTok{AsspFileFormat}\NormalTok{(ado) }\OtherTok{\textless{}{-}} \StringTok{"SSFF"}
\NormalTok{  wrassp}\SpecialCharTok{::}\FunctionTok{AsspDataFormat}\NormalTok{(ado) }\OtherTok{\textless{}{-}} \FunctionTok{as.integer}\NormalTok{(}\DecValTok{2}\NormalTok{)}
\NormalTok{  f0Vals }\OtherTok{=} \FunctionTok{as.integer}\NormalTok{(df[,}\StringTok{"F0"}\NormalTok{])}
\NormalTok{  ado }\OtherTok{=}\NormalTok{ wrassp}\SpecialCharTok{::}\FunctionTok{addTrack}\NormalTok{(ado, }\StringTok{"f0"}\NormalTok{, f0Vals, }\StringTok{"INT16"}\NormalTok{)}

  \CommentTok{\# prepend missing values as praat sometimes}
  \CommentTok{\# starts fairly late}
  \ControlFlowTok{if}\NormalTok{(start }\SpecialCharTok{\textgreater{}} \DecValTok{1} \SpecialCharTok{/}\NormalTok{ sR)\{}
\NormalTok{    nr\_of\_missing\_samples }\OtherTok{=} \FunctionTok{floor}\NormalTok{(start }\SpecialCharTok{/}\NormalTok{ (}\DecValTok{1}\SpecialCharTok{/}\NormalTok{sR))}

\NormalTok{    missing\_f0\_vals }\OtherTok{=} \FunctionTok{matrix}\NormalTok{(}\DecValTok{0}\NormalTok{,}
                             \AttributeTok{nrow =}\NormalTok{ nr\_of\_missing\_samples,}
                             \AttributeTok{ncol =} \FunctionTok{ncol}\NormalTok{(ado}\SpecialCharTok{$}\NormalTok{f0))}

    \CommentTok{\# prepend values}
\NormalTok{    ado}\SpecialCharTok{$}\NormalTok{f0 }\OtherTok{=} \FunctionTok{rbind}\NormalTok{(missing\_f0\_vals, ado}\SpecialCharTok{$}\NormalTok{f0)}

    \CommentTok{\# fix start time}
    \FunctionTok{attr}\NormalTok{(ado, }\StringTok{"startTime"}\NormalTok{) }\OtherTok{=}\NormalTok{ start }\SpecialCharTok{{-}}\NormalTok{ nr\_of\_missing\_samples }\SpecialCharTok{*}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{/}\NormalTok{ sR)}
    \FunctionTok{attr}\NormalTok{(ado, }\StringTok{"startTime"}\NormalTok{) }\OtherTok{=} \FunctionTok{round}\NormalTok{(}\FunctionTok{attr}\NormalTok{(ado, }\StringTok{"startTime"}\NormalTok{), }\DecValTok{6}\NormalTok{)}
\NormalTok{  \}}
  \FunctionTok{return}\NormalTok{(ado)}
\NormalTok{\}}
...
\DocumentationTok{\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#}
\CommentTok{\#}
\CommentTok{\# write Praat script to tmp dir}
\NormalTok{write\_praat\_script }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(script, tmp\_out) \{}
  \ControlFlowTok{if}\NormalTok{ (script }\SpecialCharTok{==} \StringTok{"formant"}\NormalTok{) \{}
\NormalTok{    readr}\SpecialCharTok{::}\FunctionTok{write\_lines}\NormalTok{(formant\_text, tmp\_out)}
\NormalTok{  \} }\ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{ (script }\SpecialCharTok{==} \StringTok{"pitch"}\NormalTok{) \{}
\NormalTok{    readr}\SpecialCharTok{::}\FunctionTok{write\_lines}\NormalTok{(pitch\_text, tmp\_out)}
\NormalTok{  \} }\ControlFlowTok{else}\NormalTok{ \{}
...
\DocumentationTok{\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#}
\CommentTok{\#}
\CommentTok{\# formant Praat script text}
\NormalTok{formant\_text }\OtherTok{=} \StringTok{"\# To Formant (burg)}

\StringTok{form To formants}
\StringTok{  text path ./}
\StringTok{  real time\_step 0.0}
\StringTok{  integer max\_fm 5}
\StringTok{  real ceiling 5500.0}
\StringTok{  real window 0.025}
\StringTok{  real pre\_emph 50.0}
\StringTok{  text out ./}
\StringTok{endform}

\StringTok{sound = Read from file: path$}

\StringTok{formant = To Formant (burg): time\_step, max\_fm, ceiling, window, pre\_emph}

\StringTok{table = Down to Table: }\SpecialCharTok{\textbackslash{}"}\StringTok{no}\SpecialCharTok{\textbackslash{}"}\StringTok{, }\SpecialCharTok{\textbackslash{}"}\StringTok{yes}\SpecialCharTok{\textbackslash{}"}\StringTok{, 6, }\SpecialCharTok{\textbackslash{}"}\StringTok{no}\SpecialCharTok{\textbackslash{}"}\StringTok{, 3, }\SpecialCharTok{\textbackslash{}"}\StringTok{yes}\SpecialCharTok{\textbackslash{}"}\StringTok{, 3, }\SpecialCharTok{\textbackslash{}"}\StringTok{yes}\SpecialCharTok{\textbackslash{}"}

\StringTok{Save as comma{-}separated file: out$}
...
\DocumentationTok{\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#}
\CommentTok{\#}
\CommentTok{\# formant pitch script text}
\NormalTok{pitch\_text }\OtherTok{=} \StringTok{"\# To Pitch}

\StringTok{form To pitch}
\StringTok{  text path ./}
\StringTok{  real time\_step 0.0}
\StringTok{  real pitch\_floor 75.0}
\StringTok{  real pitch\_ceiling 600.0}
\StringTok{  word pitch\_units Hertz}
\StringTok{  boolean smooth 0}
\StringTok{  real smooth\_bw 10.0}
\StringTok{  text out ./}
\StringTok{  text pitchInfo ./}
\StringTok{endform}

\StringTok{sound = Read from file: path$}

\StringTok{pitch = To Pitch: time\_step, pitch\_floor, pitch\_ceiling}

\StringTok{if smooth == 0}
\StringTok{  pitch = Smooth: smooth\_bw}
\StringTok{endif}

\StringTok{nframes = Get number of frames}
\StringTok{timestep = Get time step}
\StringTok{start = Get time from frame number: 1}
\StringTok{end = Get time from frame number: nframes}

\StringTok{header$ = }\SpecialCharTok{\textbackslash{}"}\StringTok{nframes,timestep,start,end}\SpecialCharTok{\textbackslash{}"}
\StringTok{writeFileLine(pitchInfo$, header$)}
\StringTok{line$ = }\SpecialCharTok{\textbackslash{}"}\StringTok{\textquotesingle{}nframes\textquotesingle{},\textquotesingle{}timestep\textquotesingle{},\textquotesingle{}start\textquotesingle{},\textquotesingle{}end\textquotesingle{}}\SpecialCharTok{\textbackslash{}"}
\StringTok{appendFileLine(pitchInfo$, line$)}

\StringTok{Down to PitchTier}

\StringTok{Down to TableOfReal: pitch\_units$}

\StringTok{Save as headerless spreadsheet file: out$}

\StringTok{"}
\end{Highlighting}
\end{Shaded}

The following code chunk shows how this function can be applied to \texttt{.wav} files of an emuDB.
...
\FunctionTok{create\_emuRdemoData}\NormalTok{(}\FunctionTok{tempdir}\NormalTok{())}

\CommentTok{\# create path to demo database}
\NormalTok{path2ae }\OtherTok{=} \FunctionTok{file.path}\NormalTok{(}\FunctionTok{tempdir}\NormalTok{(), }\StringTok{"emuR\_demoData"}\NormalTok{, }\StringTok{"ae\_emuDB"}\NormalTok{)}

\CommentTok{\# list all .wav files in the ae emuDB}
\NormalTok{paths2wavFiles }\OtherTok{=} \FunctionTok{list.files}\NormalTok{(path2ae, }\AttributeTok{pattern =} \StringTok{"*.wav$"}\NormalTok{,}
...
\NormalTok{  tmp1FilePath }\OtherTok{=} \FunctionTok{file.path}\NormalTok{(}\FunctionTok{tempdir}\NormalTok{(), tmp1FileName)}
  ...
  \CommentTok{\# get vals}
\NormalTok{  df }\OtherTok{=} \FunctionTok{suppressMessages}\NormalTok{(readr}\SpecialCharTok{::}\FunctionTok{read\_delim}\NormalTok{(tmp1FilePath,}
                                          \AttributeTok{delim =} \StringTok{";"}\NormalTok{))}

  \CommentTok{\# extract + remove frameIndex/frameTime}
\NormalTok{  frameIndex }\OtherTok{=}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{frameIndex}
\NormalTok{  frameTime }\OtherTok{=}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{frameTime}

\NormalTok{  df}\SpecialCharTok{$}\NormalTok{frameIndex }\OtherTok{=} \ConstantTok{NULL}
\NormalTok{  df}\SpecialCharTok{$}\NormalTok{frameTime }\OtherTok{=} \ConstantTok{NULL}

\NormalTok{  df }\OtherTok{=} \FunctionTok{as.matrix}\NormalTok{(df)}

\NormalTok{  colNames }\OtherTok{=} \FunctionTok{colnames}\NormalTok{(df)}

  \CommentTok{\# get start time}
\NormalTok{  startTime }\OtherTok{=}\NormalTok{ frameTime[}\DecValTok{1}\NormalTok{]}

  \CommentTok{\# create AsspDataObj}
\NormalTok{  ado }\OtherTok{=} \FunctionTok{list}\NormalTok{()}

  \FunctionTok{attr}\NormalTok{(ado, }\StringTok{"sampleRate"}\NormalTok{) }\OtherTok{=} \DecValTok{1}\SpecialCharTok{/}\NormalTok{frameTime[}\DecValTok{2}\NormalTok{] }\CommentTok{\# second frameTime should be stepsize}
...
\NormalTok{  tmpObj }\OtherTok{=}\NormalTok{ wrassp}\SpecialCharTok{::}\FunctionTok{read.AsspDataObj}\NormalTok{(path)}
  ...
  \FunctionTok{attr}\NormalTok{(ado, }\StringTok{"endRecord"}\NormalTok{) }\OtherTok{=} \FunctionTok{as.integer}\NormalTok{(}\FunctionTok{nrow}\NormalTok{(df))}
...
\CommentTok{\# list all .wav files in the ae emuDB}
\NormalTok{paths2wavFiles }\OtherTok{=} \FunctionTok{list.files}\NormalTok{(path2ae,}
                            \AttributeTok{pattern =} \StringTok{"*.wav$"}\NormalTok{,}
                            \AttributeTok{recursive =} \ConstantTok{TRUE}\NormalTok{,}
                            \AttributeTok{full.names =} \ConstantTok{TRUE}\NormalTok{)}
...
\CommentTok{\# loop through files}
\ControlFlowTok{for}\NormalTok{(fp }\ControlFlowTok{in}\NormalTok{ paths2wavFiles)\{}
\NormalTok{  ado }\OtherTok{=} \FunctionTok{SMILExtract2AsspDataObj}\NormalTok{(fp,}
                                \AttributeTok{SMILExtractPath =} \StringTok{"\textasciitilde{}/programs/opensmile{-}2.3.0/bin/SMILExtract"}\NormalTok{,}
                                \AttributeTok{configPath =} \StringTok{"\textasciitilde{}/programs/opensmile{-}2.3.0/config/demo/demo1\_energy.conf"}\NormalTok{)}
\NormalTok{  newPath }\OtherTok{=} \FunctionTok{paste0}\NormalTok{(}\FunctionTok{file\_path\_sans\_ext}\NormalTok{(fp), }\StringTok{\textquotesingle{}.SMILExtract\textquotesingle{}}\NormalTok{)}
  \CommentTok{\# print(paste0(fp, \textquotesingle{} {-}\textgreater{} \textquotesingle{}, newPath)) \# uncomment for simple log}
  \FunctionTok{write.AsspDataObj}\NormalTok{(ado, }\AttributeTok{file =}\NormalTok{ newPath)}
\NormalTok{\}}
...
\CommentTok{\# add SSFF track definition}
\FunctionTok{add\_ssffTrackDefinition}\NormalTok{(ae,}
                        \AttributeTok{name =} \StringTok{"SMILExtract"}\NormalTok{,}
                        \AttributeTok{columnName =} \StringTok{"pcm\_LOGenergy"}\NormalTok{,}
                        \AttributeTok{fileExtension =} \StringTok{"SMILExtract"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{unique}\NormalTok{(sS.dft}\SpecialCharTok{$}\NormalTok{sample\_rate)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{freqs }\OtherTok{=} \FunctionTok{seq}\NormalTok{(}\AttributeTok{from=}\DecValTok{0}\NormalTok{,}\AttributeTok{to=}\FunctionTok{unique}\NormalTok{(sS.dft}\SpecialCharTok{$}\NormalTok{sample\_rate),}\AttributeTok{length.out =} \DecValTok{257}\NormalTok{)}
\NormalTok{freqs[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{5}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{sS.dctCoefficients }\OtherTok{=}
\NormalTok{  sS.dftlong }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(labels, sl\_rowIdx) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{do}\NormalTok{(}\FunctionTok{data\_frame}\NormalTok{(}\AttributeTok{DCT =}\NormalTok{ emuR}\SpecialCharTok{::}\FunctionTok{dct}\NormalTok{(.}\SpecialCharTok{$}\NormalTok{track\_value, }\AttributeTok{m =} \DecValTok{5}\NormalTok{, }\AttributeTok{fit =}\NormalTok{ F))) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{DCTCOEF =} \FunctionTok{paste0}\NormalTok{(}\StringTok{"k"}\NormalTok{, }\DecValTok{0}\SpecialCharTok{:}\NormalTok{(}\FunctionTok{table}\NormalTok{(sl\_rowIdx) }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{))) }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{  tidyr}\SpecialCharTok{::}\FunctionTok{spread}\NormalTok{(DCTCOEF, DCT)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{a }\OtherTok{=} \FunctionTok{ggplot}\NormalTok{(sS2to3thousandHz) }\SpecialCharTok{+}
  \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ labels, }\AttributeTok{y =}\NormalTok{ amplitudes\_2000\_3000Hz, }\AttributeTok{col =}\NormalTok{ labels) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{()}

\CommentTok{\# or calculate k0 in the same frequency range:}
\NormalTok{sS.dctCoefficients2to3thousandHz }\OtherTok{=}
\NormalTok{  sS.dftlong }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(freq}\SpecialCharTok{\textgreater{}=}\DecValTok{2000} \SpecialCharTok{\&}\NormalTok{ freq }\SpecialCharTok{\textless{}=} \DecValTok{3000}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(labels,sl\_rowIdx) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{do}\NormalTok{(}\FunctionTok{data\_frame}\NormalTok{(}\AttributeTok{DCT =}\NormalTok{ emuR}\SpecialCharTok{::}\FunctionTok{dct}\NormalTok{(.}\SpecialCharTok{$}\NormalTok{track\_value, }\AttributeTok{m =} \DecValTok{5}\NormalTok{, }\AttributeTok{fit =}\NormalTok{ F))) }\SpecialCharTok{\%\textgreater{}\%}
...
\NormalTok{b }\OtherTok{=} \FunctionTok{ggplot}\NormalTok{(sS.dctCoefficients2to3thousandHz)}\SpecialCharTok{+}
  \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ labels, }\AttributeTok{y =}\NormalTok{ k0, }\AttributeTok{col =}\NormalTok{ labels)}\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{()}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sS.moments }\OtherTok{=}
\NormalTok{  sS.dftlong }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(labels,sl\_rowIdx) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{do}\NormalTok{(}\FunctionTok{data\_frame}\NormalTok{(}\AttributeTok{Moments =}\NormalTok{ emuR}\SpecialCharTok{::}\FunctionTok{moments}\NormalTok{(.}\SpecialCharTok{$}\NormalTok{track\_value,.}\SpecialCharTok{$}\NormalTok{freq))) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{Momentnumbers =} \FunctionTok{paste0}\NormalTok{(}\StringTok{"Moment"}\NormalTok{,}\DecValTok{1}\SpecialCharTok{:}\NormalTok{(}\FunctionTok{table}\NormalTok{(sl\_rowIdx)))) }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{  tidyr}\SpecialCharTok{::}\FunctionTok{spread}\NormalTok{(Momentnumbers, Moments)}
...
\NormalTok{  sS.dftlong }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(labels, sl\_rowIdx) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{do}\NormalTok{(}\FunctionTok{data\_frame}\NormalTok{(}\AttributeTok{Moments =}\NormalTok{ emuR}\SpecialCharTok{::}\FunctionTok{moments}\NormalTok{(.}\SpecialCharTok{$}\NormalTok{track\_value,.}\SpecialCharTok{$}\NormalTok{freq, }\AttributeTok{minval =} \ConstantTok{TRUE}\NormalTok{))) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{Momentnumbers =} \FunctionTok{paste0}\NormalTok{(}\StringTok{"Moment"}\NormalTok{, }\DecValTok{1}\SpecialCharTok{:}\NormalTok{(}\FunctionTok{table}\NormalTok{(sl\_rowIdx)))) }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{  tidyr}\SpecialCharTok{::}\FunctionTok{spread}\NormalTok{(Momentnumbers, Moments)}
...
\NormalTok{repo }\OtherTok{=}\NormalTok{ git2r}\SpecialCharTok{::}\FunctionTok{init}\NormalTok{(}\AttributeTok{path =}\NormalTok{ db}\SpecialCharTok{$}\NormalTok{basePath)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{git2r}\SpecialCharTok{::}\FunctionTok{add}\NormalTok{(db}\SpecialCharTok{$}\NormalTok{basePath, }\AttributeTok{path =} \StringTok{"*"}\NormalTok{)}
\CommentTok{\# and commit}
\NormalTok{git2r}\SpecialCharTok{::}\FunctionTok{commit}\NormalTok{(db}\SpecialCharTok{$}\NormalTok{basePath, }
              \AttributeTok{message =} \StringTok{"initial commit"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{git2r}\SpecialCharTok{::}\FunctionTok{remote\_add}\NormalTok{(db}\SpecialCharTok{$}\NormalTok{basePath, }
                  \AttributeTok{name =} \StringTok{"origin"}\NormalTok{, }
                  \AttributeTok{url =} \StringTok{"https://gitlab.lrz.de/raphywink/ae\_emuDB.git"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{git2r}\SpecialCharTok{::}\FunctionTok{push}\NormalTok{(db}\SpecialCharTok{$}\NormalTok{basePath, }
            \AttributeTok{name =} \StringTok{"origin"}\NormalTok{,}
            \AttributeTok{refspec =} \StringTok{"refs/heads/master"}\NormalTok{,}
            \AttributeTok{set\_upstream =} \ConstantTok{TRUE}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{git2r}\SpecialCharTok{::}\FunctionTok{pull}\NormalTok{(db}\SpecialCharTok{$}\NormalTok{basePath, }
            \AttributeTok{credentials =}\NormalTok{ git2r}\SpecialCharTok{::}\FunctionTok{cred\_token}\NormalTok{(}\AttributeTok{token =} \StringTok{"GITLAB\_PAT"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{git2r}\SpecialCharTok{::}\FunctionTok{add}\NormalTok{(db}\SpecialCharTok{$}\NormalTok{basePath, }\StringTok{"*"}\NormalTok{)}
\NormalTok{git2r}\SpecialCharTok{::}\FunctionTok{commit}\NormalTok{(db}\SpecialCharTok{$}\NormalTok{basePath, }
              \AttributeTok{message =} \StringTok{"added new bundleList"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
