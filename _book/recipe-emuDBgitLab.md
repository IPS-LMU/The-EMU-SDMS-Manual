...
```
## [2a93cb7] 2020-12-17: initial commit
```
...
```
## [1] "INFO: No bundleList dir found in emuDB (path: C:\\Users\\rapha\\AppData\\Local\\Temp\\RtmpoFYFsb\\emuR_demoData\\ae_emuDB/bundleLists)! Creating directory..."
```
