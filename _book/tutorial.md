...
```
## Name:	 my-first 
## UUID:	 b1e71d2f-4aec-4951-b6f0-8aee2ca54447 
## Directory:	 /tmp/RtmptmoZ8r/my-first_emuDB 
## Session count: 1 
## Bundle count: 7 
...
##  1 n      1032. 1196. b1e71d… 0000    msajc…            98          98 Phon…
##  2 n      1741. 1791. b1e71d… 0000    msajc…           108         108 Phon…
##  3 n      1515. 1554. b1e71d… 0000    msajc…           113         113 Phon…
##  4 n      2431. 2528. b1e71d… 0000    msajc…           127         127 Phon…
##  5 n       895. 1023. b1e71d… 0000    msajc…            98          98 Phon…
##  6 n      2402. 2475. b1e71d… 0000    msajc…           122         122 Phon…
##  7 n      2227. 2271. b1e71d… 0000    msajc…           132         132 Phon…
##  8 n      3046. 3068. b1e71d… 0000    msajc…           145         145 Phon…
##  9 n      1435. 1495. b1e71d… 0000    msajc…            91          91 Phon…
## 10 n      1775. 1834. b1e71d… 0000    msajc…            96          96 Phon…
## 11 n       509.  544. b1e71d… 0000    msajc…            97          97 Phon…
## 12 n      2448. 2480. b1e71d… 0000    msajc…           130         130 Phon…
...
##    labels start   end db_uuid session bundle start_item_id end_item_id level
##    <chr>  <dbl> <dbl> <chr>   <chr>   <chr>          <int>       <int> <chr>
##  1 @      1506. 1548. b1e71d… 0000    msajc…           103         103 Phon…
##  2 @      1715. 1741. b1e71d… 0000    msajc…           107         107 Phon…
##  3 @      1967. 2034. b1e71d… 0000    msajc…           112         112 Phon…
##  4 @      2303. 2362. b1e71d… 0000    msajc…           117         117 Phon…
##  5 @      2447. 2506. b1e71d… 0000    msajc…           119         119 Phon…
##  6 @      1917. 1958. b1e71d… 0000    msajc…           118         118 Phon…
##  7 @      2022. 2078. b1e71d… 0000    msajc…           120         120 Phon…
##  8 @      2382. 2431. b1e71d… 0000    msajc…           126         126 Phon…
##  9 @       330.  380. b1e71d… 0000    msajc…            91          91 Phon…
## 10 @      1472. 1490. b1e71d… 0000    msajc…           108         108 Phon…
...
##    labels start   end db_uuid session bundle start_item_id end_item_id level
##    <chr>  <dbl> <dbl> <chr>   <chr>   <chr>          <int>       <int> <chr>
##  1 F         NA    NA b1e71d… 0000    msajc…            16          16 Word 
##  2 C         NA    NA b1e71d… 0000    msajc…            17          17 Word 
##  3 C         NA    NA b1e71d… 0000    msajc…            17          17 Word 
##  4 C         NA    NA b1e71d… 0000    msajc…            18          18 Word 
##  5 C         NA    NA b1e71d… 0000    msajc…            18          18 Word 
##  6 C         NA    NA b1e71d… 0000    msajc…            19          19 Word 
##  7 C         NA    NA b1e71d… 0000    msajc…            20          20 Word 
##  8 C         NA    NA b1e71d… 0000    msajc…            20          20 Word 
##  9 F         NA    NA b1e71d… 0000    msajc…            13          13 Word 
## 10 F         NA    NA b1e71d… 0000    msajc…            17          17 Word 
## # … with 18 more rows, and 7 more variables: attribute <chr>,
## #   start_item_seq_idx <int>, end_item_seq_idx <int>, type <chr>,
## #   sample_start <int>, sample_end <int>, sample_rate <int>
```
...
##  1         5 @      2447. 2506. b1e71d… 0000    msajc…           119         119
##  2         5 @      2447. 2506. b1e71d… 0000    msajc…           119         119
##  3         5 @      2447. 2506. b1e71d… 0000    msajc…           119         119
##  4         5 @      2447. 2506. b1e71d… 0000    msajc…           119         119
##  5         5 @      2447. 2506. b1e71d… 0000    msajc…           119         119
##  6         5 @      2447. 2506. b1e71d… 0000    msajc…           119         119
##  7         5 @      2447. 2506. b1e71d… 0000    msajc…           119         119
##  8         5 @      2447. 2506. b1e71d… 0000    msajc…           119         119
##  9         5 @      2447. 2506. b1e71d… 0000    msajc…           119         119
## 10         5 @      2447. 2506. b1e71d… 0000    msajc…           119         119
## 11         5 @      2447. 2506. b1e71d… 0000    msajc…           119         119
## 12         5 @      2447. 2506. b1e71d… 0000    msajc…           119         119
