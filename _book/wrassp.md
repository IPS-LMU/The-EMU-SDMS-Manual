...
```
## Assp Data Object of file /var/folders/yk/8z9tn7kx6hbcg_9n4c1sld980000gn/T//RtmppbUQgi/emuR_demoData/ae_emuDB/0000_ses/msajc003_bndl/msajc003.wav.
## Format: WAVE (binary)
...
## [3] "##################################"
## [4] "######## ksvF0 performed ########" 
## [5] "Timestamp:  2018-10-18 16:07:14 "  
## [6] "windowShift : 10 "                 
## [7] "forceToLog : T "                   
## [8] " => on files:"
```
