...
\begin{verbatim}
## Name:     my-first 
## UUID:     6e24d034-a765-4da3-b35b-a3a939f586b7 
## Directory:    /tmp/RtmpFZoUtk/my-first_emuDB 
## Session count: 1 
## Bundle count: 7 
...
##  1 n      1032. 1196. 6e24d0… 0000    msajc…            98          98 Phon…
##  2 n      1741. 1791. 6e24d0… 0000    msajc…           108         108 Phon…
##  3 n      1515. 1554. 6e24d0… 0000    msajc…           113         113 Phon…
##  4 n      2431. 2528. 6e24d0… 0000    msajc…           127         127 Phon…
##  5 n       895. 1023. 6e24d0… 0000    msajc…            98          98 Phon…
##  6 n      2402. 2475. 6e24d0… 0000    msajc…           122         122 Phon…
##  7 n      2227. 2271. 6e24d0… 0000    msajc…           132         132 Phon…
##  8 n      3046. 3068. 6e24d0… 0000    msajc…           145         145 Phon…
##  9 n      1435. 1495. 6e24d0… 0000    msajc…            91          91 Phon…
## 10 n      1775. 1834. 6e24d0… 0000    msajc…            96          96 Phon…
## 11 n       509.  544. 6e24d0… 0000    msajc…            97          97 Phon…
## 12 n      2448. 2480. 6e24d0… 0000    msajc…           130         130 Phon…
...
##    labels start   end db_uuid session bundle start_item_id end_item_id level
##    <chr>  <dbl> <dbl> <chr>   <chr>   <chr>          <int>       <int> <chr>
##  1 @      1506. 1548. 6e24d0… 0000    msajc…           103         103 Phon…
##  2 @      1715. 1741. 6e24d0… 0000    msajc…           107         107 Phon…
##  3 @      1967. 2034. 6e24d0… 0000    msajc…           112         112 Phon…
##  4 @      2303. 2362. 6e24d0… 0000    msajc…           117         117 Phon…
##  5 @      2447. 2506. 6e24d0… 0000    msajc…           119         119 Phon…
##  6 @      1917. 1958. 6e24d0… 0000    msajc…           118         118 Phon…
##  7 @      2022. 2078. 6e24d0… 0000    msajc…           120         120 Phon…
##  8 @      2382. 2431. 6e24d0… 0000    msajc…           126         126 Phon…
##  9 @       330.  380. 6e24d0… 0000    msajc…            91          91 Phon…
## 10 @      1472. 1490. 6e24d0… 0000    msajc…           108         108 Phon…
...
##    labels start   end db_uuid session bundle start_item_id end_item_id level
##    <chr>  <dbl> <dbl> <chr>   <chr>   <chr>          <int>       <int> <chr>
##  1 F         NA    NA 6e24d0… 0000    msajc…            16          16 Word 
##  2 C         NA    NA 6e24d0… 0000    msajc…            17          17 Word 
##  3 C         NA    NA 6e24d0… 0000    msajc…            17          17 Word 
##  4 C         NA    NA 6e24d0… 0000    msajc…            18          18 Word 
##  5 C         NA    NA 6e24d0… 0000    msajc…            18          18 Word 
##  6 C         NA    NA 6e24d0… 0000    msajc…            19          19 Word 
##  7 C         NA    NA 6e24d0… 0000    msajc…            20          20 Word 
##  8 C         NA    NA 6e24d0… 0000    msajc…            20          20 Word 
##  9 F         NA    NA 6e24d0… 0000    msajc…            13          13 Word 
## 10 F         NA    NA 6e24d0… 0000    msajc…            17          17 Word 
## # … with 18 more rows, and 7 more variables: attribute <chr>,
## #   start_item_seq_idx <int>, end_item_seq_idx <int>, type <chr>,
## #   sample_start <int>, sample_end <int>, sample_rate <int>
\end{verbatim}
...
##  1         5 @      2447. 2506. 6e24d0… 0000    msajc…           119         119
##  2         5 @      2447. 2506. 6e24d0… 0000    msajc…           119         119
##  3         5 @      2447. 2506. 6e24d0… 0000    msajc…           119         119
##  4         5 @      2447. 2506. 6e24d0… 0000    msajc…           119         119
##  5         5 @      2447. 2506. 6e24d0… 0000    msajc…           119         119
##  6         5 @      2447. 2506. 6e24d0… 0000    msajc…           119         119
##  7         5 @      2447. 2506. 6e24d0… 0000    msajc…           119         119
##  8         5 @      2447. 2506. 6e24d0… 0000    msajc…           119         119
##  9         5 @      2447. 2506. 6e24d0… 0000    msajc…           119         119
## 10         5 @      2447. 2506. 6e24d0… 0000    msajc…           119         119
## 11         5 @      2447. 2506. 6e24d0… 0000    msajc…           119         119
## 12         5 @      2447. 2506. 6e24d0… 0000    msajc…           119         119
...
\begin{verbatim}
## Name:     fromScratch 
## UUID:     9f0eb8da-0d5f-4d2d-846a-e4a6fa01f8e4 
## Directory:    /tmp/RtmpyWYRfd/fromScratch_emuDB 
## Session count: 0 
## Bundle count: 0 
...
##    <chr>      <chr>   <chr>        <chr>                                        
##  1 fromWavFi… msajc0… msajc003_an… /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
##  2 fromWavFi… msajc0… msajc003.wav /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
##  3 fromWavFi… msajc0… msajc010_an… /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
##  4 fromWavFi… msajc0… msajc010.wav /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
##  5 fromWavFi… msajc0… msajc012_an… /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
##  6 fromWavFi… msajc0… msajc012.wav /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
##  7 fromWavFi… msajc0… msajc015_an… /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
##  8 fromWavFi… msajc0… msajc015.wav /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
##  9 fromWavFi… msajc0… msajc022_an… /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
## 10 fromWavFi… msajc0… msajc022.wav /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
## 11 fromWavFi… msajc0… msajc023_an… /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
## 12 fromWavFi… msajc0… msajc023.wav /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
## 13 fromWavFi… msajc0… msajc057_an… /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
## 14 fromWavFi… msajc0… msajc057.wav /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
\end{verbatim}
...
##  1 fromWavFi… msajc0… msajc003_an… /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
##  2 fromWavFi… msajc0… msajc003.wav /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
##  3 fromWavFi… msajc0… msajc003.zcr /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
##  4 fromWavFi… msajc0… msajc010_an… /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
##  5 fromWavFi… msajc0… msajc010.wav /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
##  6 fromWavFi… msajc0… msajc010.zcr /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
##  7 fromWavFi… msajc0… msajc012_an… /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
##  8 fromWavFi… msajc0… msajc012.wav /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
##  9 fromWavFi… msajc0… msajc012.zcr /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
## 10 fromWavFi… msajc0… msajc015_an… /tmp/RtmpyWYRfd/fromScratch_emuDB/fromWavFil…
## # … with 11 more rows
\end{verbatim}
...
##   session bundle   file      absolute_file_path                                 
##   <chr>   <chr>    <chr>     <chr>                                              
## 1 0000    msajc003 msajc003… /tmp/RtmpqyFD8R/emuR_demoData/ae_emuDB/0000_ses/ms…
## 2 0000    msajc010 msajc010… /tmp/RtmpqyFD8R/emuR_demoData/ae_emuDB/0000_ses/ms…
## 3 0000    msajc012 msajc012… /tmp/RtmpqyFD8R/emuR_demoData/ae_emuDB/0000_ses/ms…
## 4 0000    msajc015 msajc015… /tmp/RtmpqyFD8R/emuR_demoData/ae_emuDB/0000_ses/ms…
## 5 0000    msajc022 msajc022… /tmp/RtmpqyFD8R/emuR_demoData/ae_emuDB/0000_ses/ms…
## 6 0000    msajc023 msajc023… /tmp/RtmpqyFD8R/emuR_demoData/ae_emuDB/0000_ses/ms…
## 7 0000    msajc057 msajc057… /tmp/RtmpqyFD8R/emuR_demoData/ae_emuDB/0000_ses/ms…
\end{verbatim}
...
\begin{verbatim}
## Assp Data Object of file /tmp/Rtmp5L4By1/emuR_demoData/ae_emuDB/0000_ses/msajc003_bndl/msajc003.wav.
## Format: WAVE (binary)
...
## 
## $filePath
## [1] "/tmp/Rtmp5L4By1/emuR_demoData/ae_emuDB/0000_s..."
## 
## $origFreq
## [1] 0
## 
...
## [1] ""                                   "##################################"
## [3] "##################################" "######## ksvF0 performed ########" 
## [5] "Timestamp:  2020-01-07 15:51:47 "   "windowShift : 10 "                 
...
\begin{verbatim}
## [eebbe28] 2020-01-07: initial commit
\end{verbatim}
...
\begin{verbatim}
## [1] "INFO: No bundleList dir found in emuDB (path: /tmp/RtmpSOJL9w/emuR_demoData/ae_emuDB/bundleLists)! Creating directory..."
\end{verbatim}
