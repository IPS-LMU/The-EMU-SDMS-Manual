...
\begin{verbatim}
## Name:     my-first 
## UUID:     71e7c966-9113-4d5c-81fb-8f85870628c9 
## Directory:    /tmp/RtmpHE7MYf/my-first_emuDB 
## Session count: 1 
## Bundle count: 7 
...
## 1 n      1032. 1196. 71e7c9~ 0000    msajc~            98          98 Phon~
...
##   labels start   end db_uuid session bundle start_item_id end_item_id level
##   <chr>  <dbl> <dbl> <chr>   <chr>   <chr>          <int>       <int> <chr>
## 1 @      1506. 1548. 71e7c9~ 0000    msajc~           103         103 Phon~
## # ... with 7 more variables: attribute <chr>, start_item_seq_idx <int>,
## #   end_item_seq_idx <int>, type <chr>, sample_start <int>, sample_end <int>,
## #   sample_rate <int>
\end{verbatim}
...
##   labels start   end db_uuid session bundle start_item_id end_item_id level
##   <chr>  <dbl> <dbl> <chr>   <chr>   <chr>          <int>       <int> <chr>
## 1 F         NA    NA 71e7c9~ 0000    msajc~            16          16 Word 
## # ... with 7 more variables: attribute <chr>, start_item_seq_idx <int>,
## #   end_item_seq_idx <int>, type <chr>, sample_start <int>, sample_end <int>,
## #   sample_rate <int>
\end{verbatim}
...
##  1         5 @      2447. 2506. 71e7c9~ 0000    msajc~           119         119
##  2         5 @      2447. 2506. 71e7c9~ 0000    msajc~           119         119
##  3         5 @      2447. 2506. 71e7c9~ 0000    msajc~           119         119
##  4         5 @      2447. 2506. 71e7c9~ 0000    msajc~           119         119
##  5         5 @      2447. 2506. 71e7c9~ 0000    msajc~           119         119
##  6         5 @      2447. 2506. 71e7c9~ 0000    msajc~           119         119
##  7         5 @      2447. 2506. 71e7c9~ 0000    msajc~           119         119
##  8         5 @      2447. 2506. 71e7c9~ 0000    msajc~           119         119
##  9         5 @      2447. 2506. 71e7c9~ 0000    msajc~           119         119
## 10         5 @      2447. 2506. 71e7c9~ 0000    msajc~           119         119
## 11         5 @      2447. 2506. 71e7c9~ 0000    msajc~           119         119
## 12         5 @      2447. 2506. 71e7c9~ 0000    msajc~           119         119
...
\begin{verbatim}
## Name:     fromScratch 
## UUID:     ad575580-6390-4b0d-a4f9-ba94b420b917 
## Directory:    /tmp/RtmpellMXo/fromScratch_emuDB 
## Session count: 0 
## Bundle count: 0 
...
##   <chr>      <chr>   <chr>        <chr>                                         
## 1 fromWavFi~ msajc0~ msajc003_an~ /tmp/RtmpellMXo/fromScratch_emuDB/fromWavFile~
## 2 fromWavFi~ msajc0~ msajc003.wav /tmp/RtmpellMXo/fromScratch_emuDB/fromWavFile~
\end{verbatim}
...
## 1 fromWavFi~ msajc0~ msajc003_an~ /tmp/RtmpellMXo/fromScratch_emuDB/fromWavFile~
## 2 fromWavFi~ msajc0~ msajc003.wav /tmp/RtmpellMXo/fromScratch_emuDB/fromWavFile~
## 3 fromWavFi~ msajc0~ msajc003.zcr /tmp/RtmpellMXo/fromScratch_emuDB/fromWavFile~
\end{verbatim}
...
##   session bundle   file      absolute_file_path                                 
##   <chr>   <chr>    <chr>     <chr>                                              
## 1 0000    msajc003 msajc003~ /tmp/RtmptadJ4k/emuR_demoData/ae_emuDB/0000_ses/ms~
## 2 0000    msajc010 msajc010~ /tmp/RtmptadJ4k/emuR_demoData/ae_emuDB/0000_ses/ms~
## 3 0000    msajc012 msajc012~ /tmp/RtmptadJ4k/emuR_demoData/ae_emuDB/0000_ses/ms~
## 4 0000    msajc015 msajc015~ /tmp/RtmptadJ4k/emuR_demoData/ae_emuDB/0000_ses/ms~
## 5 0000    msajc022 msajc022~ /tmp/RtmptadJ4k/emuR_demoData/ae_emuDB/0000_ses/ms~
## 6 0000    msajc023 msajc023~ /tmp/RtmptadJ4k/emuR_demoData/ae_emuDB/0000_ses/ms~
## 7 0000    msajc057 msajc057~ /tmp/RtmptadJ4k/emuR_demoData/ae_emuDB/0000_ses/ms~
\end{verbatim}
...
\begin{verbatim}
## Assp Data Object of file /tmp/RtmpzNSayl/emuR_demoData/ae_emuDB/0000_ses/msajc003_bndl/msajc003.wav.
## Format: WAVE (binary)
...
## 
## $filePath
## [1] "/tmp/RtmpzNSayl/emuR_demoData/ae_emuDB/0000_s..."
## 
## $origFreq
## [1] 0
## 
...
## [1] ""                                   "##################################"
## [3] "##################################" "######## ksvF0 performed ########" 
## [5] "Timestamp:  2019-11-18 15:54:56 "   "windowShift : 10 "                 
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# git2r:: prefix can be ommited}
...
\begin{verbatim}
## [0cde6ae] 2019-11-18: initial commit
\end{verbatim}
...
Adding this token to your \texttt{.Renviron} file has the advantage that you will not have to include your token as part of your R scripts which makes your scripts transferable. As the \texttt{.Renviron} file is read during R's start-up please close and reopen RStudio.
...
\OtherTok{[}
    \FunctionTok{\{}
        ...
        \DataTypeTok{"comment"}\FunctionTok{:} \StringTok{"slight due"}\FunctionTok{,}
...
\begin{verbatim}
## [1] "INFO: No bundleList dir found in emuDB (path: /tmp/Rtmp03omTq/emuR_demoData/ae_emuDB/bundleLists)! Creating directory..."
\end{verbatim}
...
\item
  \texttt{projectID=44728}: project ID (see project page of GitLab determine the projects ID)
\item
  \texttt{emuDBname=ae}: name of emuDB used to identify \texttt{\_DBconfig.json} prefix
\item
  \texttt{bundleListName=raphael.winkelmann}: name of bundleList to access
\item
  \texttt{privateToken=reQFspQnbCHbvTfHjwfP}: used for read and write access
\end{itemize}
...
This step is usually performed by the project maintainer and the URLs are simply sent to the various annotators in the project. The only parameters the annotators have to set themselfs is their \texttt{privateToken}s. Once the link is opened in a browser, the EMU-webApp will have full read and write access to the repository and should open the first bundle in the bundle list automatically. On save a new commit is added to the repository of the updates made.
