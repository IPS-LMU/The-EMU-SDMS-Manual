...
\begin{verbatim}
## Name:     my-first 
## UUID:     c00b3dbe-1bcb-4f3c-b46b-a32a7538b18c 
## Directory:    /tmp/RtmpPLDLwQ/my-first_emuDB 
## Session count: 1 
## Bundle count: 7 
...
## 1 n      1032. 1196. c00b3d~ 0000    msajc~            98          98 Phon~
...
##   labels start   end db_uuid session bundle start_item_id end_item_id level
##   <chr>  <dbl> <dbl> <chr>   <chr>   <chr>          <int>       <int> <chr>
## 1 @      1506. 1548. c00b3d~ 0000    msajc~           103         103 Phon~
## # ... with 7 more variables: attribute <chr>, start_item_seq_idx <int>,
## #   end_item_seq_idx <int>, type <chr>, sample_start <int>, sample_end <int>,
## #   sample_rate <int>
\end{verbatim}
...
##   labels start   end db_uuid session bundle start_item_id end_item_id level
##   <chr>  <dbl> <dbl> <chr>   <chr>   <chr>          <int>       <int> <chr>
## 1 F         NA    NA c00b3d~ 0000    msajc~            16          16 Word 
## # ... with 7 more variables: attribute <chr>, start_item_seq_idx <int>,
## #   end_item_seq_idx <int>, type <chr>, sample_start <int>, sample_end <int>,
## #   sample_rate <int>
\end{verbatim}
...
##  1         5 @      2447. 2506. c00b3d~ 0000    msajc~           119         119
##  2         5 @      2447. 2506. c00b3d~ 0000    msajc~           119         119
##  3         5 @      2447. 2506. c00b3d~ 0000    msajc~           119         119
##  4         5 @      2447. 2506. c00b3d~ 0000    msajc~           119         119
##  5         5 @      2447. 2506. c00b3d~ 0000    msajc~           119         119
##  6         5 @      2447. 2506. c00b3d~ 0000    msajc~           119         119
##  7         5 @      2447. 2506. c00b3d~ 0000    msajc~           119         119
##  8         5 @      2447. 2506. c00b3d~ 0000    msajc~           119         119
##  9         5 @      2447. 2506. c00b3d~ 0000    msajc~           119         119
## 10         5 @      2447. 2506. c00b3d~ 0000    msajc~           119         119
## 11         5 @      2447. 2506. c00b3d~ 0000    msajc~           119         119
## 12         5 @      2447. 2506. c00b3d~ 0000    msajc~           119         119
...
\begin{verbatim}
## Name:     fromScratch 
## UUID:     ca2fddc1-ee65-4c06-826c-895f666e99dd 
## Directory:    /tmp/RtmphjS1md/fromScratch_emuDB 
## Session count: 0 
## Bundle count: 0 
...
##   <chr>      <chr>   <chr>        <chr>                                         
## 1 fromWavFi~ msajc0~ msajc003_an~ /tmp/RtmphjS1md/fromScratch_emuDB/fromWavFile~
## 2 fromWavFi~ msajc0~ msajc003.wav /tmp/RtmphjS1md/fromScratch_emuDB/fromWavFile~
\end{verbatim}
...
## 1 fromWavFi~ msajc0~ msajc003_an~ /tmp/RtmphjS1md/fromScratch_emuDB/fromWavFile~
## 2 fromWavFi~ msajc0~ msajc003.wav /tmp/RtmphjS1md/fromScratch_emuDB/fromWavFile~
## 3 fromWavFi~ msajc0~ msajc003.zcr /tmp/RtmphjS1md/fromScratch_emuDB/fromWavFile~
\end{verbatim}
...
##   session bundle   file      absolute_file_path                                 
##   <chr>   <chr>    <chr>     <chr>                                              
## 1 0000    msajc003 msajc003~ /tmp/Rtmp74T2OB/emuR_demoData/ae_emuDB/0000_ses/ms~
## 2 0000    msajc010 msajc010~ /tmp/Rtmp74T2OB/emuR_demoData/ae_emuDB/0000_ses/ms~
## 3 0000    msajc012 msajc012~ /tmp/Rtmp74T2OB/emuR_demoData/ae_emuDB/0000_ses/ms~
## 4 0000    msajc015 msajc015~ /tmp/Rtmp74T2OB/emuR_demoData/ae_emuDB/0000_ses/ms~
## 5 0000    msajc022 msajc022~ /tmp/Rtmp74T2OB/emuR_demoData/ae_emuDB/0000_ses/ms~
## 6 0000    msajc023 msajc023~ /tmp/Rtmp74T2OB/emuR_demoData/ae_emuDB/0000_ses/ms~
## 7 0000    msajc057 msajc057~ /tmp/Rtmp74T2OB/emuR_demoData/ae_emuDB/0000_ses/ms~
\end{verbatim}
...
\begin{verbatim}
## Assp Data Object of file /tmp/RtmpZnaLMA/emuR_demoData/ae_emuDB/0000_ses/msajc003_bndl/msajc003.wav.
## Format: WAVE (binary)
...
## 
## $filePath
## [1] "/tmp/RtmpZnaLMA/emuR_demoData/ae_emuDB/0000_s..."
## 
## $origFreq
## [1] 0
## 
...
## [1] ""                                   "##################################"
## [3] "##################################" "######## ksvF0 performed ########" 
## [5] "Timestamp:  2019-11-22 17:09:50 "   "windowShift : 10 "                 
...
\begin{verbatim}
## [7494fc3] 2019-11-22: initial commit
\end{verbatim}
...
\begin{verbatim}
## [1] "INFO: No bundleList dir found in emuDB (path: /tmp/Rtmp5p7sod/emuR_demoData/ae_emuDB/bundleLists)! Creating directory..."
\end{verbatim}
