...
\begin{verbatim}
## Name:     myFirst 
## UUID:     f432065c-f245-4b55-b9c6-a91500482932 
## Directory:    /private/var/folders/yk/8z9tn7kx6hbcg_9n4c1sld980000gn/T/Rtmp6rnZAl/myFirst_emuDB 
## Session count: 1 
## Bundle count: 7 
...
\begin{verbatim}
## Name:     fromScratch 
## UUID:     0101ca07-da85-4a79-8eee-4f1203309b81 
## Directory:    /private/var/folders/yk/8z9tn7kx6hbcg_9n4c1sld980000gn/T/RtmpcUcrhu/fromScratch_emuDB 
## Session count: 0 
## Bundle count: 0 
...
\begin{verbatim}
## Assp Data Object of file /var/folders/yk/8z9tn7kx6hbcg_9n4c1sld980000gn/T//RtmpxkDR0H/emuR_demoData/ae_emuDB/0000_ses/msajc003_bndl/msajc003.wav.
## Format: WAVE (binary)
...
By analogy with to the formant estimation example, the R code snippet
below shows how the \texttt{plot()} function can be used to visualize
this data as in Figure \ref{fig:wrassp-plotF0}.
...
to log its function calls to a specified log file. The R code snippet
below shows a call to the \texttt{ksvF0()} function where a single
parameter was changed from its default value
...
## [3] "##################################"
## [4] "######## ksvF0 performed ########" 
## [5] "Timestamp:  2018-10-15 13:40:55 "  
## [6] "windowShift : 10 "                 
## [7] "forceToLog : T "                   
## [8] " => on files:"
\end{verbatim}
