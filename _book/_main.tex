...
\begin{verbatim}
## Name:     my-first 
## UUID:     e471b2db-9dd3-4bec-ae2a-a6a5604c2ae1 
## Directory:    C:\Users\rapha\AppData\Local\Temp\RtmpWwFKqL\my-first_emuDB 
## Session count: 1 
## Bundle count: 7 
...
##  1 n      1032. 1196. e471b2~ 0000    msajc~            98          98 Phon~
##  2 n      1741. 1791. e471b2~ 0000    msajc~           108         108 Phon~
##  3 n      1515. 1554. e471b2~ 0000    msajc~           113         113 Phon~
##  4 n      2431. 2528. e471b2~ 0000    msajc~           127         127 Phon~
##  5 n       895. 1023. e471b2~ 0000    msajc~            98          98 Phon~
##  6 n      2402. 2475. e471b2~ 0000    msajc~           122         122 Phon~
##  7 n      2227. 2271. e471b2~ 0000    msajc~           132         132 Phon~
##  8 n      3046. 3068. e471b2~ 0000    msajc~           145         145 Phon~
##  9 n      1435. 1495. e471b2~ 0000    msajc~            91          91 Phon~
## 10 n      1775. 1834. e471b2~ 0000    msajc~            96          96 Phon~
## 11 n       509.  544. e471b2~ 0000    msajc~            97          97 Phon~
## 12 n      2448. 2480. e471b2~ 0000    msajc~           130         130 Phon~
...
##    labels start   end db_uuid session bundle start_item_id end_item_id level
##    <chr>  <dbl> <dbl> <chr>   <chr>   <chr>          <int>       <int> <chr>
##  1 @      1506. 1548. e471b2~ 0000    msajc~           103         103 Phon~
##  2 @      1715. 1741. e471b2~ 0000    msajc~           107         107 Phon~
##  3 @      1967. 2034. e471b2~ 0000    msajc~           112         112 Phon~
##  4 @      2303. 2362. e471b2~ 0000    msajc~           117         117 Phon~
##  5 @      2447. 2506. e471b2~ 0000    msajc~           119         119 Phon~
##  6 @      1917. 1958. e471b2~ 0000    msajc~           118         118 Phon~
##  7 @      2022. 2078. e471b2~ 0000    msajc~           120         120 Phon~
##  8 @      2382. 2431. e471b2~ 0000    msajc~           126         126 Phon~
##  9 @       330.  380. e471b2~ 0000    msajc~            91          91 Phon~
## 10 @      1472. 1490. e471b2~ 0000    msajc~           108         108 Phon~
...
##    labels start   end db_uuid session bundle start_item_id end_item_id level
##    <chr>  <dbl> <dbl> <chr>   <chr>   <chr>          <int>       <int> <chr>
##  1 F         NA    NA e471b2~ 0000    msajc~            16          16 Word 
##  2 C         NA    NA e471b2~ 0000    msajc~            17          17 Word 
##  3 C         NA    NA e471b2~ 0000    msajc~            17          17 Word 
##  4 C         NA    NA e471b2~ 0000    msajc~            18          18 Word 
##  5 C         NA    NA e471b2~ 0000    msajc~            18          18 Word 
##  6 C         NA    NA e471b2~ 0000    msajc~            19          19 Word 
##  7 C         NA    NA e471b2~ 0000    msajc~            20          20 Word 
##  8 C         NA    NA e471b2~ 0000    msajc~            20          20 Word 
##  9 F         NA    NA e471b2~ 0000    msajc~            13          13 Word 
## 10 F         NA    NA e471b2~ 0000    msajc~            17          17 Word 
## # ... with 18 more rows, and 7 more variables: attribute <chr>,
## #   start_item_seq_idx <int>, end_item_seq_idx <int>, type <chr>,
## #   sample_start <int>, sample_end <int>, sample_rate <int>
\end{verbatim}
...
##  1         5 @      2447. 2506. e471b2~ 0000    msajc~           119         119
##  2         5 @      2447. 2506. e471b2~ 0000    msajc~           119         119
##  3         5 @      2447. 2506. e471b2~ 0000    msajc~           119         119
##  4         5 @      2447. 2506. e471b2~ 0000    msajc~           119         119
##  5         5 @      2447. 2506. e471b2~ 0000    msajc~           119         119
##  6         5 @      2447. 2506. e471b2~ 0000    msajc~           119         119
##  7         5 @      2447. 2506. e471b2~ 0000    msajc~           119         119
##  8         5 @      2447. 2506. e471b2~ 0000    msajc~           119         119
##  9         5 @      2447. 2506. e471b2~ 0000    msajc~           119         119
## 10         5 @      2447. 2506. e471b2~ 0000    msajc~           119         119
## 11         5 @      2447. 2506. e471b2~ 0000    msajc~           119         119
## 12         5 @      2447. 2506. e471b2~ 0000    msajc~           119         119
...
\begin{verbatim}
## Name:     fromScratch 
## UUID:     5b6234c8-b589-4e1f-b480-b55a165c2c4a 
## Directory:    C:\Users\rapha\AppData\Local\Temp\Rtmp6BRidT\fromScratch_emuDB 
## Session count: 0 
## Bundle count: 0 
...
##   session bundle   file     absolute_file_path                                  
##   <chr>   <chr>    <chr>    <chr>                                               
## 1 0000    msajc003 msajc00~ "C:\\Users\\rapha\\AppData\\Local\\Temp\\RtmpEhWmnv~
## 2 0000    msajc010 msajc01~ "C:\\Users\\rapha\\AppData\\Local\\Temp\\RtmpEhWmnv~
## 3 0000    msajc012 msajc01~ "C:\\Users\\rapha\\AppData\\Local\\Temp\\RtmpEhWmnv~
## 4 0000    msajc015 msajc01~ "C:\\Users\\rapha\\AppData\\Local\\Temp\\RtmpEhWmnv~
## 5 0000    msajc022 msajc02~ "C:\\Users\\rapha\\AppData\\Local\\Temp\\RtmpEhWmnv~
## 6 0000    msajc023 msajc02~ "C:\\Users\\rapha\\AppData\\Local\\Temp\\RtmpEhWmnv~
## 7 0000    msajc057 msajc05~ "C:\\Users\\rapha\\AppData\\Local\\Temp\\RtmpEhWmnv~
\end{verbatim}
...
\begin{verbatim}
## Assp Data Object of file C:\Users\rapha\AppData\Local\Temp\RtmpIjl1cN\emuR_demoData\ae_emuDB\0000_ses\msajc003_bndl\msajc003.wav.
## Format: WAVE (binary)
...
## 
## $filePath
## [1] "C:\\Users\\rapha\\AppData\\Local\\Temp\\RtmpIjl1cN\\emuR_demoData\\ae_emuDB\\0000_ses\\msajc003_bndl\\msajc003.wav"
## 
## $origFreq
## [1] 0
## 
...
## [1] ""                                   "##################################"
## [3] "##################################" "######## ksvF0 performed ########" 
## [5] "Timestamp:  2020-12-16 20:48:55 "   "windowShift : 10 "                 
...
\begin{verbatim}
## [53fda33] 2020-12-16: initial commit
\end{verbatim}
...
\begin{verbatim}
## [1] "INFO: No bundleList dir found in emuDB (path: C:\\Users\\rapha\\AppData\\Local\\Temp\\RtmpQj3VXc\\emuR_demoData\\ae_emuDB/bundleLists)! Creating directory..."
\end{verbatim}
