...
\begin{verbatim}
## Name:     myFirst 
## UUID:     0bbf3cef-596e-4b2e-8cfb-9facdf12f8bd 
## Directory:    /private/var/folders/yk/8z9tn7kx6hbcg_9n4c1sld980000gn/T/RtmpmBI4mg/myFirst_emuDB 
## Session count: 1 
## Bundle count: 7 
...
\texttt{emuDB} contains four levels of annotations. The R code snippet
below shows four separate queries that query various segments on each of
the available levels. The query expressions all use the matching
operator \texttt{==} which returns annotation items whose labels match
those specified to the right of the operator and that belong to the
level specified to the left of the operator (i.e.,
\texttt{LEVEL\ ==\ LABEL}; see Chapter \ref{chap:querysys} for a
...
\texttt{cut} parameter. The R code snippet below shows an alternative
approach using the \texttt{dcut()} function to essentially cut the
formant trajectories to a specified proportional segment. By using only
the \texttt{left.time\ =\ 0.5} (and not specifying \texttt{right.time})
only the formant values that are closest to the temporal mid-point are
cut from the trajectories.
...
\begin{verbatim}
## Name:     fromScratch 
## UUID:     ab543345-7daf-47a7-ac5c-0a6cbc6914f8 
## Directory:    /private/var/folders/yk/8z9tn7kx6hbcg_9n4c1sld980000gn/T/Rtmpewo6rm/fromScratch_emuDB 
## Session count: 0 
## Bundle count: 0 
...
\begin{verbatim}
## Assp Data Object of file /var/folders/yk/8z9tn7kx6hbcg_9n4c1sld980000gn/T//Rtmp8DABqk/emuR_demoData/ae_emuDB/0000_ses/msajc003_bndl/msajc003.wav.
## Format: WAVE (binary)
...
## [3] "##################################"
## [4] "######## ksvF0 performed ########" 
## [5] "Timestamp:  2018-07-04 15:26:33 "  
## [6] "windowShift : 10 "                 
## [7] "forceToLog : T "                   
## [8] " => on files:"
\end{verbatim}
