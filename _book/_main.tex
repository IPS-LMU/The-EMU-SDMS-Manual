...
\begin{verbatim}
## Name:     my-first 
## UUID:     08ed88bc-6634-4f19-8f90-4a51af3727a5 
## Directory:    /tmp/RtmpoE0iOD/my-first_emuDB 
## Session count: 1 
## Bundle count: 7 
...
## 1 n      1032. 1196. 08ed88~ 0000    msajc~            98          98 Phon~
...
##   labels start   end db_uuid session bundle start_item_id end_item_id level
##   <chr>  <dbl> <dbl> <chr>   <chr>   <chr>          <int>       <int> <chr>
## 1 @      1506. 1548. 08ed88~ 0000    msajc~           103         103 Phon~
## # ... with 7 more variables: attribute <chr>, start_item_seq_idx <int>,
## #   end_item_seq_idx <int>, type <chr>, sample_start <int>, sample_end <int>,
## #   sample_rate <int>
\end{verbatim}
...
##   labels start   end db_uuid session bundle start_item_id end_item_id level
##   <chr>  <dbl> <dbl> <chr>   <chr>   <chr>          <int>       <int> <chr>
## 1 F         NA    NA 08ed88~ 0000    msajc~            16          16 Word 
## # ... with 7 more variables: attribute <chr>, start_item_seq_idx <int>,
## #   end_item_seq_idx <int>, type <chr>, sample_start <int>, sample_end <int>,
## #   sample_rate <int>
\end{verbatim}
...
##  1         5 @      2447. 2506. 08ed88~ 0000    msajc~           119         119
##  2         5 @      2447. 2506. 08ed88~ 0000    msajc~           119         119
##  3         5 @      2447. 2506. 08ed88~ 0000    msajc~           119         119
##  4         5 @      2447. 2506. 08ed88~ 0000    msajc~           119         119
##  5         5 @      2447. 2506. 08ed88~ 0000    msajc~           119         119
##  6         5 @      2447. 2506. 08ed88~ 0000    msajc~           119         119
##  7         5 @      2447. 2506. 08ed88~ 0000    msajc~           119         119
##  8         5 @      2447. 2506. 08ed88~ 0000    msajc~           119         119
##  9         5 @      2447. 2506. 08ed88~ 0000    msajc~           119         119
## 10         5 @      2447. 2506. 08ed88~ 0000    msajc~           119         119
## 11         5 @      2447. 2506. 08ed88~ 0000    msajc~           119         119
## 12         5 @      2447. 2506. 08ed88~ 0000    msajc~           119         119
...
\begin{verbatim}
## Name:     fromScratch 
## UUID:     43e6ea93-67e4-44d6-b898-cd033a00bf48 
## Directory:    /tmp/RtmpO6zHHz/fromScratch_emuDB 
## Session count: 0 
## Bundle count: 0 
...
##   <chr>      <chr>   <chr>        <chr>                                         
## 1 fromWavFi~ msajc0~ msajc003_an~ /tmp/RtmpO6zHHz/fromScratch_emuDB/fromWavFile~
## 2 fromWavFi~ msajc0~ msajc003.wav /tmp/RtmpO6zHHz/fromScratch_emuDB/fromWavFile~
\end{verbatim}
...
## 1 fromWavFi~ msajc0~ msajc003_an~ /tmp/RtmpO6zHHz/fromScratch_emuDB/fromWavFile~
## 2 fromWavFi~ msajc0~ msajc003.wav /tmp/RtmpO6zHHz/fromScratch_emuDB/fromWavFile~
## 3 fromWavFi~ msajc0~ msajc003.zcr /tmp/RtmpO6zHHz/fromScratch_emuDB/fromWavFile~
\end{verbatim}
...
##   session bundle   file      absolute_file_path                                 
##   <chr>   <chr>    <chr>     <chr>                                              
## 1 0000    msajc003 msajc003~ /tmp/RtmpzgeldQ/emuR_demoData/ae_emuDB/0000_ses/ms~
## 2 0000    msajc010 msajc010~ /tmp/RtmpzgeldQ/emuR_demoData/ae_emuDB/0000_ses/ms~
## 3 0000    msajc012 msajc012~ /tmp/RtmpzgeldQ/emuR_demoData/ae_emuDB/0000_ses/ms~
## 4 0000    msajc015 msajc015~ /tmp/RtmpzgeldQ/emuR_demoData/ae_emuDB/0000_ses/ms~
## 5 0000    msajc022 msajc022~ /tmp/RtmpzgeldQ/emuR_demoData/ae_emuDB/0000_ses/ms~
## 6 0000    msajc023 msajc023~ /tmp/RtmpzgeldQ/emuR_demoData/ae_emuDB/0000_ses/ms~
## 7 0000    msajc057 msajc057~ /tmp/RtmpzgeldQ/emuR_demoData/ae_emuDB/0000_ses/ms~
\end{verbatim}
...
\begin{verbatim}
## Assp Data Object of file /tmp/RtmpN8rUAY/emuR_demoData/ae_emuDB/0000_ses/msajc003_bndl/msajc003.wav.
## Format: WAVE (binary)
...
## 
## $filePath
## [1] "/tmp/RtmpN8rUAY/emuR_demoData/ae_emuDB/0000_s..."
## 
## $origFreq
## [1] 0
## 
...
## [1] ""                                   "##################################"
## [3] "##################################" "######## ksvF0 performed ########" 
## [5] "Timestamp:  2019-11-18 16:49:52 "   "windowShift : 10 "                 
...
\begin{verbatim}
## [190a5bb] 2019-11-18: initial commit
\end{verbatim}
...
\begin{verbatim}
## [1] "INFO: No bundleList dir found in emuDB (path: /tmp/RtmpRx71Lq/emuR_demoData/ae_emuDB/bundleLists)! Creating directory..."
\end{verbatim}
