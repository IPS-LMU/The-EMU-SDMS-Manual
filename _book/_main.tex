...
\begin{verbatim}
## Name:     my-first 
## UUID:     42d65c0c-6263-4f44-8aa1-c85748b76168 
## Directory:    /private/var/folders/yk/8z9tn7kx6hbcg_9n4c1sld980000gn/T/Rtmprw5Kje/my-first_emuDB 
## Session count: 1 
## Bundle count: 7 
...
##  1         5 @      2447. 2506. 0000~ 42d65c~ 0000    msajc~           119
##  2         5 @      2447. 2506. 0000~ 42d65c~ 0000    msajc~           119
##  3         5 @      2447. 2506. 0000~ 42d65c~ 0000    msajc~           119
##  4         5 @      2447. 2506. 0000~ 42d65c~ 0000    msajc~           119
##  5         5 @      2447. 2506. 0000~ 42d65c~ 0000    msajc~           119
##  6         5 @      2447. 2506. 0000~ 42d65c~ 0000    msajc~           119
##  7         5 @      2447. 2506. 0000~ 42d65c~ 0000    msajc~           119
##  8         5 @      2447. 2506. 0000~ 42d65c~ 0000    msajc~           119
##  9         5 @      2447. 2506. 0000~ 42d65c~ 0000    msajc~           119
## 10         5 @      2447. 2506. 0000~ 42d65c~ 0000    msajc~           119
## 11         5 @      2447. 2506. 0000~ 42d65c~ 0000    msajc~           119
## 12         5 @      2447. 2506. 0000~ 42d65c~ 0000    msajc~           119
...
\textbackslash{}caption\{95\% ellipse plot for F2 x F1 data extracted
from the temporal midpoint of the vowel
segments.\}\label{fig:tutorial-eplot} \textbackslash{}end\{figure\}
...
tutorial, the data exploration using the \texttt{dplyr} and
\texttt{ggplot2} packages can be very helpful tools for providing an
...
snippet below initially extracts the central 60\% (\texttt{filter()}
conditions \texttt{times\_norm\ \textgreater{}=\ 0.2} and
\texttt{times\_norm\ \textless{}=\ 0.8}) of the formant trajectories
from \texttt{td\_vowels\_norm} using \texttt{dplyr} and displays them
using \texttt{ggplot()}. It should be noted that before the call to
\texttt{ggplot()} the labels of the \texttt{td\_vowels\_mid\_sec} are
replaced with those of \texttt{sl\_word\_type}. This allows
\texttt{ggplot()} to group the trajectories by their word type as
opposed to their vowel labels as displayed in Figure
...
\begin{verbatim}
## Name:     fromScratch 
## UUID:     a7c9d61e-bf08-43a8-b76a-58a32b53a7be 
## Directory:    /private/var/folders/yk/8z9tn7kx6hbcg_9n4c1sld980000gn/T/Rtmp7dFQBi/fromScratch_emuDB 
## Session count: 0 
## Bundle count: 0 
...
\begin{verbatim}
## Assp Data Object of file /var/folders/yk/8z9tn7kx6hbcg_9n4c1sld980000gn/T//RtmpdxJici/emuR_demoData/ae_emuDB/0000_ses/msajc003_bndl/msajc003.wav.
## Format: WAVE (binary)
...
## [3] "##################################"
## [4] "######## ksvF0 performed ########" 
## [5] "Timestamp:  2018-10-18 16:03:44 "  
## [6] "windowShift : 10 "                 
## [7] "forceToLog : T "                   
## [8] " => on files:"
\end{verbatim}
