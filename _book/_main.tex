...
\begin{verbatim}
## Name:     my-first 
## UUID:     32bb8494-b3d9-4111-82ab-33e3c5352139 
## Directory:    /tmp/Rtmp9zQ9c9/my-first_emuDB 
## Session count: 1 
## Bundle count: 7 
...
## 1 n      1032. 1196. 32bb84~ 0000    msajc~            98          98 Phon~
...
##   labels start   end db_uuid session bundle start_item_id end_item_id level
##   <chr>  <dbl> <dbl> <chr>   <chr>   <chr>          <int>       <int> <chr>
## 1 @      1506. 1548. 32bb84~ 0000    msajc~           103         103 Phon~
## # ... with 7 more variables: attribute <chr>, start_item_seq_idx <int>,
## #   end_item_seq_idx <int>, type <chr>, sample_start <int>,
## #   sample_end <int>, sample_rate <int>
\end{verbatim}
...
##   labels start   end db_uuid session bundle start_item_id end_item_id level
##   <chr>  <dbl> <dbl> <chr>   <chr>   <chr>          <int>       <int> <chr>
## 1 F         NA    NA 32bb84~ 0000    msajc~            16          16 Word 
## # ... with 7 more variables: attribute <chr>, start_item_seq_idx <int>,
## #   end_item_seq_idx <int>, type <chr>, sample_start <int>,
## #   sample_end <int>, sample_rate <int>
\end{verbatim}
...
##  1         5 @      2447. 2506. 32bb84~ 0000    msajc~           119
##  2         5 @      2447. 2506. 32bb84~ 0000    msajc~           119
##  3         5 @      2447. 2506. 32bb84~ 0000    msajc~           119
##  4         5 @      2447. 2506. 32bb84~ 0000    msajc~           119
##  5         5 @      2447. 2506. 32bb84~ 0000    msajc~           119
##  6         5 @      2447. 2506. 32bb84~ 0000    msajc~           119
##  7         5 @      2447. 2506. 32bb84~ 0000    msajc~           119
##  8         5 @      2447. 2506. 32bb84~ 0000    msajc~           119
##  9         5 @      2447. 2506. 32bb84~ 0000    msajc~           119
## 10         5 @      2447. 2506. 32bb84~ 0000    msajc~           119
## 11         5 @      2447. 2506. 32bb84~ 0000    msajc~           119
## 12         5 @      2447. 2506. 32bb84~ 0000    msajc~           119
...
\begin{verbatim}
## Name:     fromScratch 
## UUID:     2b7889c7-d256-4235-95ad-9cda618cd99b 
## Directory:    /tmp/RtmpeXooRA/fromScratch_emuDB 
## Session count: 0 
## Bundle count: 0 
...
##   <chr>      <chr>   <chr>       <chr>                                     
## 1 fromWavFi~ msajc0~ msajc003_a~ /tmp/RtmpeXooRA/fromScratch_emuDB/fromWav~
## 2 fromWavFi~ msajc0~ msajc003.w~ /tmp/RtmpeXooRA/fromScratch_emuDB/fromWav~
\end{verbatim}
...
## 1 fromWavFi~ msajc0~ msajc003_a~ /tmp/RtmpeXooRA/fromScratch_emuDB/fromWav~
## 2 fromWavFi~ msajc0~ msajc003.w~ /tmp/RtmpeXooRA/fromScratch_emuDB/fromWav~
## 3 fromWavFi~ msajc0~ msajc003.z~ /tmp/RtmpeXooRA/fromScratch_emuDB/fromWav~
\end{verbatim}
...
##   session bundle   file     absolute_file_path                             
##   <chr>   <chr>    <chr>    <chr>                                          
## 1 0000    msajc003 msajc00~ /tmp/Rtmp2YvRsp/emuR_demoData/ae_emuDB/0000_se~
## 2 0000    msajc010 msajc01~ /tmp/Rtmp2YvRsp/emuR_demoData/ae_emuDB/0000_se~
## 3 0000    msajc012 msajc01~ /tmp/Rtmp2YvRsp/emuR_demoData/ae_emuDB/0000_se~
## 4 0000    msajc015 msajc01~ /tmp/Rtmp2YvRsp/emuR_demoData/ae_emuDB/0000_se~
## 5 0000    msajc022 msajc02~ /tmp/Rtmp2YvRsp/emuR_demoData/ae_emuDB/0000_se~
## 6 0000    msajc023 msajc02~ /tmp/Rtmp2YvRsp/emuR_demoData/ae_emuDB/0000_se~
## 7 0000    msajc057 msajc05~ /tmp/Rtmp2YvRsp/emuR_demoData/ae_emuDB/0000_se~
\end{verbatim}
...
\begin{verbatim}
## Assp Data Object of file /tmp/RtmpcoJHYe/emuR_demoData/ae_emuDB/0000_ses/msajc003_bndl/msajc003.wav.
## Format: WAVE (binary)
...
## 
## $filePath
## [1] "/tmp/RtmpcoJHYe/emuR_demoData/ae_emuDB/0000_s..."
## 
## $origFreq
## [1] 0
## 
...
## [3] "##################################"
## [4] "######## ksvF0 performed ########" 
## [5] "Timestamp:  2019-10-21 15:58:45 "  
## [6] "windowShift : 10 "                 
## [7] "forceToLog : T "                   
## [8] " => on files:"
\end{verbatim}
...
\begin{Highlighting}[]
\CommentTok{# in the emuDB dir}
\FunctionTok{git}\NormalTok{ remote add origin git@gitlab.lrz.de:raphywink/ae_emuDB.git }\CommentTok{# change to your URL}
