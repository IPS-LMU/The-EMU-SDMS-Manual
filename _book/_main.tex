...
\begin{verbatim}
## Name:     myFirst 
## UUID:     f34d6f52-4fbb-4d69-b3d3-37c356d42d7d 
## Directory:    /private/var/folders/yk/8z9tn7kx6hbcg_9n4c1sld980000gn/T/RtmpuxCV78/myFirst_emuDB 
## Session count: 1 
## Bundle count: 7 
...
\begin{verbatim}
## Name:     fromScratch 
## UUID:     ea22551d-66cf-47f2-9ae3-eb4a5b195c14 
## Directory:    /private/var/folders/yk/8z9tn7kx6hbcg_9n4c1sld980000gn/T/RtmpBdnCjy/fromScratch_emuDB 
## Session count: 0 
## Bundle count: 0 
...
\begin{verbatim}
## Assp Data Object of file /var/folders/yk/8z9tn7kx6hbcg_9n4c1sld980000gn/T//Rtmp0YMGBD/emuR_demoData/ae_emuDB/0000_ses/msajc003_bndl/msajc003.wav.
## Format: WAVE (binary)
...
## [3] "##################################"
## [4] "######## ksvF0 performed ########" 
## [5] "Timestamp:  2018-05-16 19:56:49 "  
## [6] "windowShift : 10 "                 
## [7] "forceToLog : T "                   
## [8] " => on files:"
\end{verbatim}
...
\item
  ...
  \begin{itemize}
  \item
    \texttt{"addTimeMode"} The mode in which time to boundaries is added
    and subtracted (\texttt{"absolute"} or \texttt{"relative"}).
  \item
...
\item
  ...
  \item
    ...
    the size of a \texttt{SEGMENT} or \texttt{EVENT} to be changed
    (i.e., move boundaries).
  \item
  ...
  \item
    \texttt{"drawCrossHairs"} A boolean value specifying whether to draw
    the cross hairs on signal canvases.
  \item
    \texttt{"drawSampleNrs"} A boolean value specifying whether to draw
    the sample numbers in the OSCI canvas if zoomed in close enough to
    see samples (mainly for debugging and development purposes).
  \item
...
\item
  ...
  \item
    ...
    \texttt{.TextGrid} file by displaying a \texttt{download\ TextGrid}
  ...
  \item
    \texttt{"connect"} A boolean value specifying whether to display the
    \texttt{connect} button in the top menu bar.
  \item
  ...
  \item
    ...
    allow the user to download a single level in the ESPS/waves+ format.
  \item
    \texttt{"resizeSignalCanvas"} A boolean value specifying whether to
    allow the user to resize the \texttt{signalCanvases}
    (\texttt{"OSCI"}, \texttt{"SPEC"}, \ldots{}).
  \item
    \texttt{"openDemoDB"} A boolean value specifying whether to show the
    \texttt{open\ demoDB} button.
  \item
    \texttt{"saveBundle"} A boolean value specifying whether to show the
    save button in bundle list side bar for each bundle.
  \item
