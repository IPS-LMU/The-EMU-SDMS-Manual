...
\begin{verbatim}
## Name:     my-first 
## UUID:     34a867ba-f747-4564-9879-594054129582 
## Directory:    /tmp/RtmpZ27Sls/my-first_emuDB 
## Session count: 1 
## Bundle count: 7 
...
##  1 n      1032. 1196. 34a867~ 0000    msajc~            98          98 Phon~
##  2 n      1741. 1791. 34a867~ 0000    msajc~           108         108 Phon~
##  3 n      1515. 1554. 34a867~ 0000    msajc~           113         113 Phon~
##  4 n      2431. 2528. 34a867~ 0000    msajc~           127         127 Phon~
##  5 n       895. 1023. 34a867~ 0000    msajc~            98          98 Phon~
##  6 n      2402. 2475. 34a867~ 0000    msajc~           122         122 Phon~
##  7 n      2227. 2271. 34a867~ 0000    msajc~           132         132 Phon~
##  8 n      3046. 3068. 34a867~ 0000    msajc~           145         145 Phon~
##  9 n      1435. 1495. 34a867~ 0000    msajc~            91          91 Phon~
## 10 n      1775. 1834. 34a867~ 0000    msajc~            96          96 Phon~
## 11 n       509.  544. 34a867~ 0000    msajc~            97          97 Phon~
## 12 n      2448. 2480. 34a867~ 0000    msajc~           130         130 Phon~
...
##    labels start   end db_uuid session bundle start_item_id end_item_id level
##    <chr>  <dbl> <dbl> <chr>   <chr>   <chr>          <int>       <int> <chr>
##  1 @      1506. 1548. 34a867~ 0000    msajc~           103         103 Phon~
##  2 @      1715. 1741. 34a867~ 0000    msajc~           107         107 Phon~
##  3 @      1967. 2034. 34a867~ 0000    msajc~           112         112 Phon~
##  4 @      2303. 2362. 34a867~ 0000    msajc~           117         117 Phon~
##  5 @      2447. 2506. 34a867~ 0000    msajc~           119         119 Phon~
##  6 @      1917. 1958. 34a867~ 0000    msajc~           118         118 Phon~
##  7 @      2022. 2078. 34a867~ 0000    msajc~           120         120 Phon~
##  8 @      2382. 2431. 34a867~ 0000    msajc~           126         126 Phon~
##  9 @       330.  380. 34a867~ 0000    msajc~            91          91 Phon~
## 10 @      1472. 1490. 34a867~ 0000    msajc~           108         108 Phon~
...
##    labels start   end db_uuid session bundle start_item_id end_item_id level
##    <chr>  <dbl> <dbl> <chr>   <chr>   <chr>          <int>       <int> <chr>
##  1 F         NA    NA 34a867~ 0000    msajc~            16          16 Word 
##  2 C         NA    NA 34a867~ 0000    msajc~            17          17 Word 
##  3 C         NA    NA 34a867~ 0000    msajc~            17          17 Word 
##  4 C         NA    NA 34a867~ 0000    msajc~            18          18 Word 
##  5 C         NA    NA 34a867~ 0000    msajc~            18          18 Word 
##  6 C         NA    NA 34a867~ 0000    msajc~            19          19 Word 
##  7 C         NA    NA 34a867~ 0000    msajc~            20          20 Word 
##  8 C         NA    NA 34a867~ 0000    msajc~            20          20 Word 
##  9 F         NA    NA 34a867~ 0000    msajc~            13          13 Word 
## 10 F         NA    NA 34a867~ 0000    msajc~            17          17 Word 
## # ... with 18 more rows, and 7 more variables: attribute <chr>,
## #   start_item_seq_idx <int>, end_item_seq_idx <int>, type <chr>,
## #   sample_start <int>, sample_end <int>, sample_rate <int>
\end{verbatim}
...
##  1         5 @      2447. 2506. 34a867~ 0000    msajc~           119         119
##  2         5 @      2447. 2506. 34a867~ 0000    msajc~           119         119
##  3         5 @      2447. 2506. 34a867~ 0000    msajc~           119         119
##  4         5 @      2447. 2506. 34a867~ 0000    msajc~           119         119
##  5         5 @      2447. 2506. 34a867~ 0000    msajc~           119         119
##  6         5 @      2447. 2506. 34a867~ 0000    msajc~           119         119
##  7         5 @      2447. 2506. 34a867~ 0000    msajc~           119         119
##  8         5 @      2447. 2506. 34a867~ 0000    msajc~           119         119
##  9         5 @      2447. 2506. 34a867~ 0000    msajc~           119         119
## 10         5 @      2447. 2506. 34a867~ 0000    msajc~           119         119
## 11         5 @      2447. 2506. 34a867~ 0000    msajc~           119         119
## 12         5 @      2447. 2506. 34a867~ 0000    msajc~           119         119
...
\begin{verbatim}
## Name:     fromScratch 
## UUID:     43ee259f-d341-4a64-9d1a-531324c88637 
## Directory:    /tmp/RtmpYGiF0f/fromScratch_emuDB 
## Session count: 0 
## Bundle count: 0 
...
##    <chr>      <chr>   <chr>        <chr>                                        
##  1 fromWavFi~ msajc0~ msajc003_an~ /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
##  2 fromWavFi~ msajc0~ msajc003.wav /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
##  3 fromWavFi~ msajc0~ msajc010_an~ /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
##  4 fromWavFi~ msajc0~ msajc010.wav /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
##  5 fromWavFi~ msajc0~ msajc012_an~ /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
##  6 fromWavFi~ msajc0~ msajc012.wav /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
##  7 fromWavFi~ msajc0~ msajc015_an~ /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
##  8 fromWavFi~ msajc0~ msajc015.wav /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
##  9 fromWavFi~ msajc0~ msajc022_an~ /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
## 10 fromWavFi~ msajc0~ msajc022.wav /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
## 11 fromWavFi~ msajc0~ msajc023_an~ /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
## 12 fromWavFi~ msajc0~ msajc023.wav /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
## 13 fromWavFi~ msajc0~ msajc057_an~ /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
## 14 fromWavFi~ msajc0~ msajc057.wav /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
\end{verbatim}
...
##  1 fromWavFi~ msajc0~ msajc003_an~ /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
##  2 fromWavFi~ msajc0~ msajc003.wav /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
##  3 fromWavFi~ msajc0~ msajc003.zcr /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
##  4 fromWavFi~ msajc0~ msajc010_an~ /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
##  5 fromWavFi~ msajc0~ msajc010.wav /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
##  6 fromWavFi~ msajc0~ msajc010.zcr /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
##  7 fromWavFi~ msajc0~ msajc012_an~ /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
##  8 fromWavFi~ msajc0~ msajc012.wav /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
##  9 fromWavFi~ msajc0~ msajc012.zcr /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
## 10 fromWavFi~ msajc0~ msajc015_an~ /tmp/RtmpYGiF0f/fromScratch_emuDB/fromWavFil~
## # ... with 11 more rows
\end{verbatim}
...
##   session bundle   file      absolute_file_path                                 
##   <chr>   <chr>    <chr>     <chr>                                              
## 1 0000    msajc003 msajc003~ /tmp/RtmpeZJvIf/emuR_demoData/ae_emuDB/0000_ses/ms~
## 2 0000    msajc010 msajc010~ /tmp/RtmpeZJvIf/emuR_demoData/ae_emuDB/0000_ses/ms~
## 3 0000    msajc012 msajc012~ /tmp/RtmpeZJvIf/emuR_demoData/ae_emuDB/0000_ses/ms~
## 4 0000    msajc015 msajc015~ /tmp/RtmpeZJvIf/emuR_demoData/ae_emuDB/0000_ses/ms~
## 5 0000    msajc022 msajc022~ /tmp/RtmpeZJvIf/emuR_demoData/ae_emuDB/0000_ses/ms~
## 6 0000    msajc023 msajc023~ /tmp/RtmpeZJvIf/emuR_demoData/ae_emuDB/0000_ses/ms~
## 7 0000    msajc057 msajc057~ /tmp/RtmpeZJvIf/emuR_demoData/ae_emuDB/0000_ses/ms~
\end{verbatim}
...
\begin{verbatim}
## Assp Data Object of file /tmp/Rtmpws8WwG/emuR_demoData/ae_emuDB/0000_ses/msajc003_bndl/msajc003.wav.
## Format: WAVE (binary)
...
## 
## $filePath
## [1] "/tmp/Rtmpws8WwG/emuR_demoData/ae_emuDB/0000_ses/msajc003_bndl/msajc003.wav"
## 
## $origFreq
## [1] 0
## 
...
## [1] ""                                   "##################################"
## [3] "##################################" "######## ksvF0 performed ########" 
## [5] "Timestamp:  2020-12-07 15:27:57 "   "windowShift : 10 "                 
...
\begin{verbatim}
## [81f2ed4] 2020-12-07: initial commit
\end{verbatim}
...
\begin{verbatim}
## [1] "INFO: No bundleList dir found in emuDB (path: /tmp/Rtmpxs5I16/emuR_demoData/ae_emuDB/bundleLists)! Creating directory..."
\end{verbatim}
