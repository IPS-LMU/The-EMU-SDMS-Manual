...
\begin{verbatim}
## Name:     my-first 
## UUID:     064d6be5-6c7d-44dc-9046-1eabc4fb7c8e 
## Directory:    /tmp/Rtmp7zCn1i/my-first_emuDB 
## Session count: 1 
## Bundle count: 7 
...
## 1 n      1032. 1196. 064d6b~ 0000    msajc~            98          98 Phon~
...
##   labels start   end db_uuid session bundle start_item_id end_item_id level
##   <chr>  <dbl> <dbl> <chr>   <chr>   <chr>          <int>       <int> <chr>
## 1 @      1506. 1548. 064d6b~ 0000    msajc~           103         103 Phon~
## # ... with 7 more variables: attribute <chr>, start_item_seq_idx <int>,
## #   end_item_seq_idx <int>, type <chr>, sample_start <int>, sample_end <int>,
## #   sample_rate <int>
\end{verbatim}
...
##   labels start   end db_uuid session bundle start_item_id end_item_id level
##   <chr>  <dbl> <dbl> <chr>   <chr>   <chr>          <int>       <int> <chr>
## 1 F         NA    NA 064d6b~ 0000    msajc~            16          16 Word 
## # ... with 7 more variables: attribute <chr>, start_item_seq_idx <int>,
## #   end_item_seq_idx <int>, type <chr>, sample_start <int>, sample_end <int>,
## #   sample_rate <int>
\end{verbatim}
...
##  1         5 @      2447. 2506. 064d6b~ 0000    msajc~           119         119
##  2         5 @      2447. 2506. 064d6b~ 0000    msajc~           119         119
##  3         5 @      2447. 2506. 064d6b~ 0000    msajc~           119         119
##  4         5 @      2447. 2506. 064d6b~ 0000    msajc~           119         119
##  5         5 @      2447. 2506. 064d6b~ 0000    msajc~           119         119
##  6         5 @      2447. 2506. 064d6b~ 0000    msajc~           119         119
##  7         5 @      2447. 2506. 064d6b~ 0000    msajc~           119         119
##  8         5 @      2447. 2506. 064d6b~ 0000    msajc~           119         119
##  9         5 @      2447. 2506. 064d6b~ 0000    msajc~           119         119
## 10         5 @      2447. 2506. 064d6b~ 0000    msajc~           119         119
## 11         5 @      2447. 2506. 064d6b~ 0000    msajc~           119         119
## 12         5 @      2447. 2506. 064d6b~ 0000    msajc~           119         119
...
\begin{verbatim}
## Name:     fromScratch 
## UUID:     8c8822a9-2b79-4c7d-b403-7a4fc902b452 
## Directory:    /tmp/RtmplU6pEy/fromScratch_emuDB 
## Session count: 0 
## Bundle count: 0 
...
##   <chr>      <chr>   <chr>        <chr>                                         
## 1 fromWavFi~ msajc0~ msajc003_an~ /tmp/RtmplU6pEy/fromScratch_emuDB/fromWavFile~
## 2 fromWavFi~ msajc0~ msajc003.wav /tmp/RtmplU6pEy/fromScratch_emuDB/fromWavFile~
\end{verbatim}
...
## 1 fromWavFi~ msajc0~ msajc003_an~ /tmp/RtmplU6pEy/fromScratch_emuDB/fromWavFile~
## 2 fromWavFi~ msajc0~ msajc003.wav /tmp/RtmplU6pEy/fromScratch_emuDB/fromWavFile~
## 3 fromWavFi~ msajc0~ msajc003.zcr /tmp/RtmplU6pEy/fromScratch_emuDB/fromWavFile~
\end{verbatim}
...
##   session bundle   file      absolute_file_path                                 
##   <chr>   <chr>    <chr>     <chr>                                              
## 1 0000    msajc003 msajc003~ /tmp/RtmpN6hRPE/emuR_demoData/ae_emuDB/0000_ses/ms~
## 2 0000    msajc010 msajc010~ /tmp/RtmpN6hRPE/emuR_demoData/ae_emuDB/0000_ses/ms~
## 3 0000    msajc012 msajc012~ /tmp/RtmpN6hRPE/emuR_demoData/ae_emuDB/0000_ses/ms~
## 4 0000    msajc015 msajc015~ /tmp/RtmpN6hRPE/emuR_demoData/ae_emuDB/0000_ses/ms~
## 5 0000    msajc022 msajc022~ /tmp/RtmpN6hRPE/emuR_demoData/ae_emuDB/0000_ses/ms~
## 6 0000    msajc023 msajc023~ /tmp/RtmpN6hRPE/emuR_demoData/ae_emuDB/0000_ses/ms~
## 7 0000    msajc057 msajc057~ /tmp/RtmpN6hRPE/emuR_demoData/ae_emuDB/0000_ses/ms~
\end{verbatim}
...
\begin{verbatim}
## Assp Data Object of file /tmp/RtmptHNZNR/emuR_demoData/ae_emuDB/0000_ses/msajc003_bndl/msajc003.wav.
## Format: WAVE (binary)
...
## 
## $filePath
## [1] "/tmp/RtmptHNZNR/emuR_demoData/ae_emuDB/0000_s..."
## 
## $origFreq
## [1] 0
## 
...
## [1] ""                                   "##################################"
## [3] "##################################" "######## ksvF0 performed ########" 
## [5] "Timestamp:  2019-11-18 15:27:51 "   "windowShift : 10 "                 
...
\begin{verbatim}
## [f6c93ef] 2019-11-18: initial commit
\end{verbatim}
...
\begin{verbatim}
## [1] "INFO: No bundleList dir found in emuDB (path: /tmp/RtmpXmah26/emuR_demoData/ae_emuDB/bundleLists)! Creating directory..."
\end{verbatim}
