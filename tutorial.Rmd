...
```{r tutorial-dplot1, fig.cap = "`ggplot()` plots of all F1 *\\@* vowel trajectories.", fig.align="center", echo=FALSE, fig.width=6, fig.height=6}
# load package
library(ggplot2)
...
```{r tutorial-dplot2, fig.cap = "`ggplot()` plots of the F1 smoothed conditional mean trajectories of all *\\@* vowels.", fig.align="center", echo=FALSE, fig.width=6, fig.height=6}
# normalize length of segments
td_vowels_norm = normalize_length(td_vowels)
