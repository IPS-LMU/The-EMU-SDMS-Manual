...
```{r tutorial-violentlyHier, fig.cap = "Example of a hierarchical annotation of the content (==*C*) word *violently* belonging to the *msajc012* bundle of the *myFirst* demo `emuDB`.", echo=FALSE, fig.width=4.5, fig.height=3}
library(ggplot2)
