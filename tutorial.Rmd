...
```{r tutorial-eplot, results='hide', message=FALSE, fig.cap = "95% ellipses for F2 x F1 data extracted from the temporal midpoint of the vowel segments.", fig.align="center", echo=FALSE, fig.width=6, fig.height=6}
td_vowels_midpoint = dcut(td_vowels,
                          left.time = 0.5,
                          prop = TRUE)
...
```{r tutorial-stats1, fig.cap = "Plots of density distributions of vowels in content words (left plot) and vowels in function words (right plot) in R Example @ref(rexample:tutorial_stats1).", fig.align="center", echo=FALSE, fig.width=6, fig.height=3}
# two plots next to each other
par(mfrow = c(1,2))
