...
```{r eqlExamples, echo=FALSE, message=FALSE}
library(dplyr)
library(knitr)
...
```{r query-requery, fig.cap="Three-step (query (green) -> requery_hier (orange) -> requery_seq (purple)) requery procedure, its single query (grey) counterpart and their color coded movements within the annotation hierarchy.", fig.align="center", echo=FALSE, out.width = "75%"}
